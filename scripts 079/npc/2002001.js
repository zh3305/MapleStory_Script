...
var beauty = 0;
var price = 5000000;
var mhair = Array(33340, 33350, 33230, 33240, 33250, 33260, 33310, 33320, 33280, 33290, 33300, 33150, 33200, 33220, 33210, 33140, 33120, 33130, 33170, 33160, 33110, 30900, 30910, 30920, 30930, 30940, 30950, 30990, 30800, 30810, 30820, 30830, 30840, 30850, 30860, 30870, 30880, 30890, 30700, 30710, 30720, 30730, 30740, 30750, 30760, 30770, 30780, 30790, 30600, 30610, 30620, 30630, 30640, 30650, 30660, 30670, 30680, 30510, 30520, 30530, 30540, 30550, 30560, 30400, 30410, 30420, 30430, 30440, 30450, 30460, 30470, 30480, 30490, 30300, 30310, 30320, 30330, 30340, 30350, 30360, 30370, 30000, 30020, 30030, 30040, 30050, 30060, 30100, 30110, 30120, 30130, 30140, 30150, 30160, 30170, 30180, 30190, 30200, 30210, 30220, 30230, 30240, 30250, 30260, 30270, 30280, 30290, 33000, 33030, 33040, 33050, 30610);
var fhair = Array(34290, 34300, 34270, 34280, 34140, 34150,31990, 34220, 34230, 34240, 34250, 34260, 34200, 34210, 34170, 34110, 34120, 34130, 34160, 33140, 34180, 34000, 34010, 34040, 34050, 34060, 31910, 31920, 31930, 31940, 31950, 31800, 31810, 31820, 31830, 31840, 31850, 31860, 31870, 31880, 31890, 31740, 31700, 31710, 31720, 31730, 31750, 31760, 31770, 31780, 31790, 31110, 31120, 31130, 31140, 31150, 31300, 31310, 31320, 31330, 31340, 31350, 31160, 31170, 31180, 31190, 31050, 31610, 31620, 31630, 31640, 31650, 31660, 31670, 31680, 31690, 31100, 31510, 31520, 31530, 31540, 31550, 31560, 31400, 31410, 31420, 31430, 31440, 31450, 31460, 31470, 31480, 31490, 31030, 31080, 31000, 31010, 31020, 31040, 31060, 31090, 31070, 31200, 31210, 31220, 31230, 31240, 31250, 31260, 31270, 31280, 31290);
var hairnew = Array();
...
function action(mode, type, selection){
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendSimple("#k"+cm.mxdmz()+"冒险岛,092免费发型.不花一分钱就可以获得最新发型~本服会不断更新~请支持5元冒险岛~#k\r\n#L4#肤色#l\r\n#L3#发型#r[New][092]#k#l\r\n#L2#头发颜色#l\r\n#L0#眼睛#l\r\n#L1#眼晴颜色#l");
		} else if (status == 1) {
		if (selection == 0) {
				facenew = Array();

...
if (status == 0)
cm.sendAcceptDecline("#b"+cm.mxdmz()+"冒险岛#k,答题系统[定期开启].适合新人玩家.\r\n#r点击接受,开始你的智力考核吧.#k");

else if (status == 1)
cm.sendSimple("#b"+cm.mxdmz()+"冒险岛#k,请各位细心答题.答题奖励绝对丰富！#b\r\n#L0#开始答题!#l\r\n#L1#如何解释答题?#l\r\n#L2#查看答题奖励#l");
...
cm.sendNext("#b可获得必成卷轴,椅子,特殊玩具哦,如果你答题到了一般,选择不在继续,将可以获得小部分奖励.");
status = 0;
} else if (selection == 3) {
...
var junkWeap = new Array(1432043,1432000, 1432001, 1432009, 1432024, 1432042, 1432002, 1442039, 1442048, 
				 1442007, 1442061, 1442035, 1442024, 1442025, 1382000, 1382003, 1382018, 
				 1382042, 1382004, 1382015, 1382012, 1382055, 1382019, 1382019, 1412001, 
				 ...
				 1372043, 1372022, 1372001, 1452023, 1452001, 1452032, 1472066, 1472030,
				 1472003, 1472000, 1462047, 1462023, 1462000, 1462034, 1462005, 1332021,
				 1332032, 1332007, 1332070, 1332067, 1332006, 1312033, 1312005, 1312018,
				 1322051, 1322004, 1322010, 1322053);//普通武器

var useable = new Array(2022280, 2022073, 2022112, 2022089, 2010000, 2022180, 2022178, 2100016, 2100000, 2102006, 2100001, 2100007);//消耗设置

var goodEqWeap = new Array(1432039, 1432007, 1432040, 1432045, 1432018, 1432011, 1432030, 1442034, 1442020, 
			   1442019, 1442045, 1442044, 1382053, 1382007, 1382034, 1382024, 1382056, 1382008, 
			   1382016, 1382035, 1382037, 1412018, 1412007, 1412019, 1412027, 1412008, 1412025, 
			   1412032, 1412009, 1412010, 1412021, 1422027, 1422013, 1422022, 1422010, 1422029, 
			   1422009, 1422005, 1422025, 1402037, 1402035, 1402016, 1402034, 1402004, 1402012, 
			   1402039, 1372010, 1372016, 1372008, 1372015, 1372033, 1372025, 1452017, 1452019, 
			   1452020, 1452014, 1452012, 1452052, 1472028, 1472031, 1472062, 1472053, 1472033, 
			   1462017, 1462015, 1462021, 1462013, 1332069, 1332072, 1332026, 1332051, 1332052, 
			   1312030, 1312015, 1312010, 1312004, 1312016, 1322045, 1322059, 1322020, 1322019,
			   1322029); //玩具设置

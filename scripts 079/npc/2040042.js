...
if (mode == -1) {
cm.sendOk("#b"+cm.mxdmz()+"冒险岛特色介绍\r\n㈠."+cm.mxdmz()+"冒险岛，无限破攻，5W倍经验.\r\n㈡.管理员不定时举办活动，自由随时怪物攻城.\r\n㈢.Boss掉落物品换元宝，普通玩家照样做爷！\r\n㈣.本服完美修复结婚，增加092新发型.\r\n㈤.增加最近流行的062，079武器坐骑.\r\n㈥.本服会不断更新自创武器，请支持"+cm.mxdmz()+"冒险岛.");
cm.dispose();
} else {
if (mode == 0) {
cm.sendOk("#b"+cm.mxdmz()+"冒险岛特色介绍\r\n㈠."+cm.mxdmz()+"冒险岛，无限破攻，5W倍经验.\r\n㈡.管理员不定时举办活动，自由随时怪物攻城.\r\n㈢.Boss掉落物品换元宝，普通玩家照样做爷！\r\n㈣.本服完美修复结婚，增加092新发型.\r\n㈤.增加最近流行的062，079武器坐骑.\r\n㈥.本服会不断更新自创武器，请支持"+cm.mxdmz()+"冒险岛.");
...
var text = "#b"+cm.mxdmz()+"#k,喇叭供应商.\r\n#b  会员等级:#r"+vipstr+"  #b剩余元宝:#r" + cm.getChar().getzb() + "#k#b 块  #b转生:#r" + cm.getChar().getReborns() + "#k#b 次\r\n";

text += "#L3#"+ttt+"使用会员免费喇叭"+ttt3+"#l\r\n";

text += "#L4#"+ttt+"使用全服无敌喊话"+ttt3+"#l\r\n"; 

text += "#L6#"+ttt2+"使用刷屏无敌喊话"+ttt3+"#l  ";

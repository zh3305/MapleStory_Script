	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if(finalitem.length != 0){
				...
				cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.odinms.tools.MaplePacketCreator.getItemMegas(cm.getC().getChannel(),cm.getPlayer().getName() + " : " + "从【绯红骑士团任务】获得！大家一起恭喜他（她）吧！！！",toDrop, true).getBytes());

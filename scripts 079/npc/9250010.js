var status = 0;
var starTime = "下午13时00分00秒";    //注意时间日期格式。时分秒分别两位数字,前面可为零
var endTime = "下午11时59分00秒"     //时间为12小时制，前面必须加上午或下午 
...
cm.sendOk("此活动只有1转以上或120级以上的玩家有资格参加。");
cm.dispose();
}
}else if(selection == 1){
cm.sendOk("此活动于每天#b" + starTime + "#k开始到#b" + endTime + "#k结束! 活动时间内,1转以上或120级以上的玩家可通过此NPC传送进跳跳活动地图,活动分为两关.跳到最上面,点击最顶上的#r#p2032003#NPC#k,既可随机获得丰厚的奖励.每人每天限制参加#r5#k次." );
cm.dispose();
}
}
}

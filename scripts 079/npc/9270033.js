...
cm.warp(541010050,0);
cm.sendOk("但愿你能坚持下来.请完成这关,下一关我将送你去挑战#b船长#k!~请收集收集500个#v4000383#像我报告.");
cm.dispose();

}else {	
cm.sendOk("但愿你能打败幽灵船长,请先展现下你的实力吧~收集300个#v4000382#.请注意时间!!!超过22点,任务将视为放弃.!");
cm.dispose();
}
...
cm.dispose();
            ...
            cm.serverNotice(" 玩家:" + cm.c.getPlayer().getName() + " 打败船长后,获得了珍贵的恶魔标识!");
cm.warp(910000000,0);

...
"游戏内，所有的东西都是要靠自己的努力得到。GM不会给任何玩家任何东西,带有管理员的装备都是非法装备,请联系GM举报.", 
...
function scheduleNew() {
    setupTask = em.schedule("start", 900000);//900000
}
...
function start() {
    scheduleNew();
    em.getChannelServer().MaplewingGX(1);//奖励语句

...
function action(mode, type, selection) {
    ...
    case 0:
        if (mode == 1) {
            if (cm.registerSquad("Akayile", 5, " 已被任命为阿卡伊勒远征队队长,请各位挑战者在5分钟内报名.")) {
                cm.sendOk("你已经被任命为阿卡伊勒远征队队长。在接下来的5分钟内，您可以添加远征队成员.请尽快加好队员.超过5分钟后将会取消远征队队长.");
            } else {

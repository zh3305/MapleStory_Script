		    ...
		    cm.warpParty(922011100);
                    ...
                    if (totplayers == 2 || debug) {
                        ...
                        if (debug) {
                          ...
                          if ((cm.getSpace(4) >= 1) && (cm.getPlayer().getItemQuantity(4001454) == 0)) {

                            cm.gainItem(4001454, 2);
                            cm.sendNext("\r\n我已经把一个#i4001454:# 放进你的背包，你可以用它来代替一个位置哦！\r\n看来你没有找到 2 " + nthobj + " 请想一个不同的组合 " + nthobj + ". 只允许 2 " + nthverb + " 或 " + nthobj + ", 或 " + nthpos + " 请记住每一个组合。");
                            cm.dispose();


                           } else {

                            cm.sendNext("你可以使用#i4001454:# 来帮助你哦！\r\n看来你没有找到 2 " + nthobj + " 请想一个不同的组合 " + nthobj + ". 只允许 2 " + nthverb + " 或 " + nthobj + ", 或 " + nthpos + " 请记住每一个组合。");
                            cm.dispose();

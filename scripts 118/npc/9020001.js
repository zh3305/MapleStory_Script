...
var minLevel = 1;//最小等级
var maxLevel = 200;//最大等级
var minPartySize = 1;//最少人数
var maxPartySize = 6;//最大人数

var nitem = 4001126;//单人通过需要的 物品
var jitem = 1;//单人通过需要的 物品的数量
        ...
        if (status == 0) {
            ...
            if (preamble == null) {
                ...
                if (complete != null) {
                    ...
                    cm.sendNext("通往下一关的门已经打开！我把你送到下一关吧！");
                    ...
                    if (totplayers == 2) {
                        ...
                        cm.sendNext("你看起来好像没有发现正确的位置，别气馁，让组队成员在绳子或踏板上找到正确的位置。");
                        cm.dispose();

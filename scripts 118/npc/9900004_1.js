...
var newJobName;
var Sp;
var jobData = Array("新手", 0, "战士", 100, "剑客", 110, "勇士", 111, "英雄", 112, "准骑士", 120, "骑士", 121, "圣骑士", 122, "枪战士", 130, "龙骑士", 131, "黑骑士", 132, "魔法师", 200, "火毒法师", 210, "火毒巫师", 211, "火毒魔导士", 212, "冰雷法师", 220, "冰雷巫师", 221, "冰雷魔导士", 222, "牧师", 230, "祭司", 231, "主教", 232, "弓箭手", 300, "猎人", 310, "射手", 311, "神射手", 312, "弩弓手", 320, "游侠", 321, "箭神", 322, "飞侠", 400, "刺客", 410, "无影人", 411, "隐士", 412, "侠客", 420, "独行客", 421, "侠盗", 422, "海盗", 500, "拳手", 510, "斗士", 511, "冲锋队长", 512, "火枪手", 520, "大副", 521, "船长", 522, "游戏管理员", 800, "游戏管理员", 900, "超级游戏管理员", 910, "初心者", 1000, "魂骑士（一转）", 1100, "魂骑士（二转）", 1110, "魂骑士（三转）", 1111, "魂骑士（四转）", 1112, "炎术士（一转）", 1200, "炎术士（二转）", 1210, "炎术士（三转）", 1211, "炎术士（四转）", 1212, "风灵使者（一转）", 1300, "风灵使者（二转）", 1310, "风灵使者（三转）", 1311, "风灵使者（四转）", 1312, "夜行者（一转）", 1400, "夜行者（二转）", 1410, "夜行者（三转）", 1411, "夜行者（四转）", 1412, "奇袭者（一转）", 1500, "奇袭者（二转）", 1510, "奇袭者（三转）", 1511, "奇袭者（四转）", 1512, "战童", 2000, "战神（一转）", 2100, "战神（二转）", 2110, "战神（三转）", 2111, "战神（四转）", 2112, "预备兵", 3000, "唤灵法师（一转）", 3200, "唤灵法师（二转）", 3210, "唤灵法师（三转）", 3211, "唤灵法师（四转）", 3212, "豹弩游侠（一转）", 3300, "豹弩游侠（二转）", 3310, "豹弩游侠（三转）", 3311, "豹弩游侠（四转）", 3312, "机械师（一转）", 3500, "机械师（二转）", 3510, "机械师（三转）", 3511, "机械师（四转）", 3512);
var first;
var sd;
var status = 0;
var job;
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getJob() % 100 == 0) {
            ...
            noAdvance += " 级才能转职，你现在的等级为 " + cm.getPlayerStat("LVL") + " 级。";
        }
    }
    if ((cm.getJob() % 10 == 2 && !cm.getJob() >= 433 && !cm.getJob() <= 430) || cm.getJob() == 900 || cm.getJob() == 910 || cm.getJob() == 800 || (cm.getJob() > 1000 && cm.getJob() < 1500 && cm.getJob() % 10 == 1)) {
        ...
        if (status == 0) {
            ...
            if (selection == 1) {
                ...
                if (cm.getSpace(1) >= 2 && cm.getSpace(2) >= 2) {
                    newJob = selection;
                    for (var i = 0; i <= jobData.length; i++)

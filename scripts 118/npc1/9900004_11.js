    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (cm.getJob() == 0) {
                ...
                cm.teachSkill(24120006, 10, 10) //手杖专家
                cm.teachSkill(24121000, 10, 10) //蓝光连击
                cm.teachSkill(24121001, 10, 10) //幻影印技天赋 Ⅳ
                cm.teachSkill(24121003, 20, 20) //暮光祝福
                cm.teachSkill(24121004, 10, 10) //圣歌祈祷
                cm.teachSkill(24121005, 0, 0) //卡片风暴
		...
		cm.teachSkill(4001013, 10, 0); //快刀斩
                ...
                cm.sendOk("恭喜您，技能以成功全满了!!");
                cm.dispose();
            } else if (cm.getJob() == 500 || cm.getJob() >= 580 && cm.getJob() <= 592) {
                //500
                ...
                cm.teachSkill(5921004, 0, 0); //金属风暴
                ...
                cm.teachSkill(23121008, 5, 0); //勇士的意志
                cm.sendOk("恭喜您，技能以成功全满了!!");
                cm.dispose();
                ...
                cm.teachSkill(35121005, 0, 0); //金属机甲：导弹战车
                ...
                cm.teachSkill(4301003, 20, 0); //暗影轻功
		...
		cm.teachSkill(4321006, 20, 0); //暗影飞跃斩
                ...
                cm.teachSkill(4340001, 30, 0); //龙卷风

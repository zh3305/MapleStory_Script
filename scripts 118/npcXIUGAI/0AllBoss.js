...
*/
        ...
        map.spawnMonsterOnGroundBelow(mobs2, new java.awt.Point(5, - 450));

        mobs3 = em.getMonster(mob8);
        eim.registerMonster(mobs3);
        map.spawnMonsterOnGroundBelow(mobs3, new java.awt.Point(5, - 450));

        mobs4 = em.getMonster(mob7);
        eim.registerMonster(mobs4);
        map.spawnMonsterOnGroundBelow(mobs4, new java.awt.Point(5, - 450));

        mobs5 = em.getMonster(mob6);
        eim.registerMonster(mobs5);
        map.spawnMonsterOnGroundBelow(mobs5, new java.awt.Point(5, - 450));

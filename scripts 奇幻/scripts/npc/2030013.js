...
function action(mode, type, selection) {
    if (cm.getPlayer().getMapId() == 211042200) { //艰苦洞穴Ⅲ
        ...
        case 10:
			...
			cm.worldSpouseMessage(0x17,"▄︻┻═┳一岛●内●新●闻●【玩家 "+ cm.getChar().getName() +" 等级："+ cm.getLevel() +"】带领远征队开始挑战【进阶扎昆】★★★");
        ...
        case 3:
            if (mode == 1) {
                ...
                if (squd != null && !squd.getAllNextPlayer().contains(cm.getPlayer().getName())) {
                    squd.setNextPlayer(cm.getPlayer().getName());
					//cm.registerSquad("ZAK", 5, " 已经成为了远征队队长。如果你想加入远征队，请重新打开对话申请加入远征队。")
        ...
        case 10:
			...
			cm.worldSpouseMessage(0x17,"▄︻┻═┳一岛●内●新●闻●【玩家 "+ cm.getChar().getName() +" 等级："+ cm.getLevel() +"】带领远征队开始挑战【扎昆】★");

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		selStr += "#r#L1#"+ aaa +" 15000抵用卷换取#t5050000#x100#l\r\n";
		selStr += "#r#L0#"+ aaa +" 800抵用卷换取#t5062000#x1( "+cm.getBossLog("抵用卷神奇")+" / 10次)#l\r\n";
		//selStr += "#L2#"+ aaa +" 1000抵用卷随即抽取120-140装备#l\r\n";
		selStr += "#L9#"+ aaa +" 1500抵用卷换取高质地喇叭1个#l\r\n";
		selStr += "#L10#"+ aaa +" 2000抵用卷换取道具喇叭1个#l\r\n";
		selStr += "#L4#"+ aaa +" 3000抵用卷换取#t5062002#x1( "+cm.getBossLog("抵用卷魔方")+" / 10次)#l\r\n";
		selStr += "#L5#"+ aaa +" 3000抵用卷换取#t2340000#( "+cm.getBossLog("抵用卷祝福")+" / 10次)#l\r\n";
		//selStr += "#L11#"+ aaa +" 3000抵用卷换取#t5067000#x1( "+cm.getBossLog("抵用卷潜能锁")+" / 10次)#l\r\n";
		selStr += "#r#L8#"+ aaa +" 3000抵用卷换取#t2049402# 100%#l\r\n";
		selStr += "#L6#"+ aaa +" 4000抵用卷换取#t2049704##l\r\n";
 ...
 cm.sendSimple(selStr);
        ...
        switch (selection) {
        case 0:
            if (cm.getPlayer().getCSPoints(2) >= 800 && cm.getBossLog("抵用卷神奇") <= 9){
                cm.gainNX(2, -800);
		cm.gainItem(5062000, 1);
		//cm.gainItem(4032246, 2);
		cm.setBossLog("抵用卷神奇");
                cm.sendOk("兑换成功。抵用卷减少800.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用800抵用卷兑换神奇魔方1个。");
		cm.dispose();
            } else {
		...
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用15000抵用卷兑换洗能力值卷轴100个");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
		...
		cm.gainItem(item[chance],1);
                cm.sendOk("兑换成功。抵用卷减少3000,获取#z"+item[chance]+"一个.");
		...
		cm.worldSpouseMessage(0x20, "『绑定校园币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1500绑定校园币抽取" + ii.getName(jizhen[chance]) + "一个。");
		cm.dispose();
            } else {
            ...
            break;
        case 4:
            if (cm.getPlayer().getCSPoints(2) >= 3000 && cm.getBossLog("抵用卷魔方") <= 9){
                cm.gainNX(2, -3000);
		cm.gainItem(5062002,1);
		cm.setBossLog("抵用卷魔方");
                cm.sendOk("兑换成功。抵用卷减少3000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用3000抵用卷兑换高级神奇魔方1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!\r\n2). 兑换次数达到上限，每天只可兑换10次。");
				cm.dispose();
		...
		cm.setBossLog("抵用卷祝福");
                cm.sendOk("兑换成功。抵用卷减少3000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用3000抵用卷兑换祝福卷轴1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!\r\n2). 兑换次数达到上限，每天只可兑换10次。");
				cm.dispose();
        ...
        case 6:
            ...
            if (cm.getPlayer().getCSPoints(2) >= 4000){
                cm.gainNX(2, -4000);
		cm.gainItem(2049704,1, 1);
                cm.sendOk("兑换成功。抵用卷减少4000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用4000抵用卷兑换A潜能卷1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
		...
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用用一千万金币兑换500抵用卷。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 金币不足。");
				cm.dispose();
		...
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用3000抵用卷兑换特100%殊潜能附加卷1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
            ...
            break;
		case 9:
            if (cm.getPlayer().getCSPoints(2) >= 1500){
                cm.gainNX(2, -1500);
		cm.gainItem(5072000,1,1);
                cm.sendOk("兑换成功。抵用卷币减少1500.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1500抵用卷兑换高质地喇叭1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
		...
		cm.gainItem(5076000,1,1);
                cm.sendOk("兑换成功。抵用卷币减少2000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用2000抵用卷兑换道具喇叭1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
		...
		cm.setBossLog("抵用卷潜能锁");
                cm.sendOk("兑换成功。抵用卷减少3000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用3000抵用卷兑换潜能锁（胶囊）1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!\r\n2). 兑换次数达到上限，每天只可兑换10次。");
				cm.dispose();

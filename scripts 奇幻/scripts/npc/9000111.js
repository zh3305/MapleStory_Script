...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			selStr +="#L2##b"+aaa+" 超级实惠理财服务130元/月[详情点击查看]#l#k\r\n\r\n";
			...
			if (selection == 1) {
				...
				typed=2;
				cm.sendYesNo("- #e#d超级实惠理财服务一月权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 400000点卷/月#k\r\n\r\n- #e#d服务特权：#n#k\r\n\t\t#b拥有全服上线提示、独特聊天颜色。\r\n- #e#d详细说明：#n#k\r\n\t\t办理后会扣掉您40万点卷，并且分30天返还45万点卷30天内每天享有三倍经验以及双倍爆率，并且30天内会返还您300个高级神奇魔方、大师级神奇魔方、防暴卷轴、祝福卷轴。另可享有免费更换发型以及快速洗血。还可以领取每日金币\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
                        } else if (selection == 3) {
				typed=3;
			...
			cm.dispose();
                ...
                if (cm.haveItem(2430865) < 1 && cm.getSpace(2) > 2 && cm.getPlayer().getCSPoints(1) >= 400000) {

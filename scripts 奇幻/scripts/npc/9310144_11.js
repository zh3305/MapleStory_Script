...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "#e#d欢迎使用绑定校园币商城，使用后将会扣除相对应的绑定校园币.购买后概不退款，请慎重请选择#n#k:\r\n";
            selStr += "#d您当前拥有绑定校园币：  #r"+cm.getPlayerPoints()+"#k #d点#k#l\r\n\r\n";
	    ...
	    selStr += "#L3#"+ttt6+" 绑定币购买礼包[各种实惠划算礼包]#l\r\n";
            selStr += "#L4#"+ttt6+" 打开充值网站进行充值[10RMB:2000点卷]#l\r\n";
            selStr += " ";

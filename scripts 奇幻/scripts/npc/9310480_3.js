        ...
        if (status == 0) {
            ...
            if (beauty == 1) {
                ...
                if (cm.getSpace(4) < sl) {
					...
					cm.worldSpouseMessage(0x20, "[元宝兑换] ： 恭喜 " + cm.getChar().getName() + " 成功将 " + (selection * 3000) + " 点卷兑换成国庆纪念币,真羡慕啊！")
                } else {
                ...
                if (cm.haveItem(4000463, selection)) {
                    cm.gainItem(4000463, -selection);
                    cm.gainNX( + 2900 * selection);
					cm.finishActivity(120113);
                    cm.sendOk("您成功将国庆纪念币#v4000463# x #r" + selection + " #k换为#r " + (2900 * selection) + " #k点卷。");
                } else {

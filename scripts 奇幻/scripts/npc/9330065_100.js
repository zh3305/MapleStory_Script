    ...
    if (status == 0) {
		...
		*/
		...
		switch(selection) {
			...
			case 1:
				typed=1;
				cm.sendYesNo("扩建花园需要#r5000W#k，扩建之后将会多出一个花盆，是否扩建？");
			break;
			case 2:
				typed=2;
				...
				for(var key in flowers) {
					if (flowers[key][1]>gardenData['level'])
						continue;
					text+="#b#L"+key+"##v"+flowers[key][0]+"# #t"+flowers[key][0]+"#种子 #r#e"+flowers[key][1]+"#n#b级 (产量："+flowers[key][4]+"~"+flowers[key][5]+")#l\r\n";
				}
				cm.sendOkS(text, 2);
			break;
		}
...
function getFlowers() {
	...
	//物品ID，等级，价格，成熟时间(小时),产量最小值，产量最大值
		...
		Array(2001534, 1, 150000, 10, 50,60), // 橙子 - 酸酸甜甜的橙子。\n恢复MP约50。
		...
		Array(5050000, 2, 6000000, 18, 5, 8), //洗点
		Array(4310030, 2, 3000000, 18, 10, 15), // - 运动会币 - 可以在村庄中的NPC彪鲁那里交换运动会装备、专用卷轴等的运动会币。
		//喇叭类
		Array(5121003, 3, 5000000, 22, 1, 2), // 参鸡汤 - 15分钟内地图上所有角色的物理攻击力+30，魔法攻击力+30。请输入想要发送的信息。
		Array(5121004, 3, 5000000, 22, 1, 2), // 松糕 - 15分钟内地图上所有角色的物理攻击力+30，魔法攻击力+30。请输入想要发送的信息。
		Array(5121005, 3, 5000000, 22, 1, 2), // 韩果 - 15分钟内地图上所有角色的物理攻击力+30，魔法攻击力+30。请输入想要发送的信息。
		Array(2432353, 4, 6000000, 24, 6, 10), //开心！转盘箱子
		Array(5110000, 5, 5000000, 26, 1, 1), // 红心巧克力
		Array(2450020, 6, 8000000, 30, 1, 3), //
		Array(2614004, 6, 10000000, 33, 5,10), //突破十万之石头
		//装备制作材料
		Array(4033356, 7, 6000000, 138, 1,1),
		Array(4000082, 7, 6000000, 58, 2, 5),
		Array(2431739, 8, 10000000, 38, 1, 2),
		Array(2450081, 9, 10000000, 52, 1, 2)
	);
}

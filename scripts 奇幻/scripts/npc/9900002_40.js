...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好，您的消费信息为:\r\n\r\n充值校园币:#r " + cm.getHyPay(1) + " #k元\r\n已消费金额:#r " + cm.getHyPay(2) + " #k元\r\n累计充值总金额:#r " + cm.getHyPay(3) + " #k元\r\n#b#L0#兑换点卷(1:3000)");
        } else if (status == 1) {
            if (cm.getHyPay(1) == 0) {
            ...
            if (cm.getHyPay(1) < selectedpay) {
                ...
                cm.sendOk("恭喜您成功兑换#b " + selectedpay * acash + " #k的点卷，本次兑换消费充值金额#r " + selectedpay + " #k元，您目前的充值校园币为:#r " + cm.getHyPay(1) + " #k元。");
            } else {

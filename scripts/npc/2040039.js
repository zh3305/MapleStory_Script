    ...
    if (stage4status == null) {
        if (cm.isLeader()) { // Leader
            ...
            if (stage4leader == "done") {
                if ((cm.getMap(922010401).getAllMonstersThreadsafe().size() == 0 && cm.getMap(922010402).getAllMonstersThreadsafe().size() == 0 && cm.getMap(922010403).getAllMonstersThreadsafe().size() == 0 && cm.getMap(922010404).getAllMonstersThreadsafe().size() == 0 && cm.getMap(922010405).getAllMonstersThreadsafe().size() == 0) || (cm.getPlayer().isLvkejian())) { // Clear stage

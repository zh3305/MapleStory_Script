...
function action(mode, type, selection) {
	if (mode == 1)
		...
		cm.dispose();
	if (status == 0 && mode == 1) {
		var selStr = "好！要是你给我母矿和服务费，我就为你治炼有用的东西。不过你先确认你背包的其它窗口里有没有空间。哦,对了，#b各类母矿在高级地图都有掉落、BOSS可以直接掉落成品哦！#k来...你想让我做什么事？#b"
		var options = new Array("治炼矿石母矿","治炼宝石母矿");
...
new Array(1412046,4021005,4021006),
new Array(1302133,4021000,4021007),
new Array(1412046,4021004,4021007),
new Array(1472100,4021004,4021007),
new Array(1472100,4021000,4021007),
new Array(1372058,4021000,4021005),
new Array(1382080,4011004,4021005),
new Array(1402072,4021000,4021001),
new Array(1412046,4011001,4021007),
new Array(1412046,4021000,4021001),
new Array(1492048,4011006,4021007),
new Array(1492048,4021004,4021005),
new Array(1452085,4011000,4021001),
new Array(1462075,4011005,4021005),
new Array(1482046,4021000,4021002),
new Array(1482046,4011008,4021007),
new Array(1482046,4021000,4021007)
);//需要的物品
...
new Array(1,10,8),
new Array(1,10,8),
new Array(1,10,8),new Array(1,10,8),new Array(1,10,8),new Array(1,10,8),
new Array(1,10,8)
);//需要的东西的个数



			var costSet = new Array(2000000,
2000000,
2000000,
2000000,
2000000,

...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        ...
        var options = new Array("制药", "制造卷轴", "捐献药材", "我想放弃修复画轴……");
        ...
        if (selectedType == 0) { //Make a medicine
            ...
            items = new Array("Scroll for One-Handed Sword for ATT", "Scroll for One-Handed Axe for ATT", "Scroll for One-Handed BW for ATT", "Scroll for Dagger for ATT", "Scroll for Wand for Magic Att.", "Scroll for Staff for Magic Att.", "Scroll for Two-handed Sword for ATT.", "Scroll for Two-handed Axe for ATT", "Scroll for Two-handed BW for ATT", "Scroll for Spear for ATT", "Scroll for Pole Arm for ATT", "Scroll for Bow for ATT", "Scroll for Crossbow for ATT ", "Scroll for Claw for ATT", "Knuckle Attack Power Scroll", "Gun Attack Power Scroll#k");

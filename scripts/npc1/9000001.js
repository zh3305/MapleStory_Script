...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendNext("你好，我是#b#p" + cm.getNpc() + "##k。我跟弟弟#b珀尔#k一起来这儿玩，弟弟说坐下一班船来的，可是我在这里等了好久也没见到他，真奇怪，怎么还没来呢？");
        } else if (status == 1) {
            cm.sendNextPrev("我们虽然是双胞胎，但是常常各自去别的地方。怎么办？活动马上要开始。。。 已经很多人过去了。可能没有几个空座。。。");
        } else if (status == 2) {
            cm.sendSimple("那个。。。如果你现在不忙的话，和我一起走，好吗？我想弟弟应该会跟别人一起来。\r\n#L0##e1.#n#b 什么样的活动?#k#l\r\n#L1##e2.#n#b 请你给我说明一下。#k#l\r\n#L2##e3.#n#b 好！跟我一起走吧！#k#l\r\n#L3##e4.#n#bPlease exchance Certificate of straight Win to reward item.#k#l");
        } else if (status == 3) {
            if (selection == 0) {
                cm.sendNext("非常高兴你能来，我们为你准备了许多有趣的活动！建议你查看活动说明以便了解活动规则。这些活动是由管理员开启才能进行，否则将不能进入专用的活动地图。有些活动是个人赛，有些需要团队合作，还会有丰富的奖品等着你。祝你好运！");
                cm.dispose();
            } else if (selection == 1) {
                cm.sendSimple("我们准备各种各样的活动。先了解游戏规吧。想了解的游戏，请选择~! #b\r\n#L0# 上楼上楼#l\r\n#L1# 向高地#l\r\n#L2# 雪球赛#l\r\n#L3# 椰子比赛#l\r\n#L4# 快速OX问答#l\r\n#L5# 寻找宝物#l\r\n#L6# 群羊牧场#l#k");
            } else if (selection == 2) {

		...
		if (status == 0) {
			...
			if(typed==5){
                if (cm.getBossLog("黑龙任务") > 2) {
                    cm.sendOk("你今天已经完成过2次任务，请明天在来。");
                    cm.dispose();
          }else if (cm.itemQuantity(4001086) >= 1) {

...
var hairnew = Array();
var mface = Array(20000, 20001, 20002, 20003, 20004, 20005, 20006, 20007, 20008, 20009, 20010, 20011, 20012, 20013, 20014, 20015, 20016, 20017, 20018, 20019, 20020, 20021, 20022, 20023, 20024, 20025, 20026, 20027, 20028, 20029,20033, 20036, 20047, 20045, 20043);
var fface = Array(21000, 21001, 21002, 21003, 21004, 21005, 21006, 21007, 21008, 21009, 21010, 21011, 21012, 21013, 21014, 21015, 21016, 21017, 21018, 21019, 21020, 21021, 21022, 21023, 21024, 21025, 21026, 21027, 21033, 21045, 21034, 21043, 21041);
var facenew = Array();
...
function action(mode, type, selection){
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendSimple("#rhallo,我可以为您美容、美发、换肤、整形喔#l!\r\n\r\n#b#L4#肤色#l\r\n#L3#发型#l\r\n#L2#头发颜色#l\r\n#L0#眼睛#l");
		} else if (status == 1) {
		if (selection == 0) {
				facenew = Array();
			...
			cm.dispose();
			if(beauty == 0){
				if(cm.haveItem(5152001) == 980){
					cm.gainItem(5152001, -980);

    ...
    if (status == 0) {
        ...
        if (cm.getJob() == 400) {
            if (cm.getPlayerStat("LVL") >= 20 && cm.getJob() == 400) {
                ...
                cm.sendOk("#r" + cm.getVipname() + " #b  如果你还是一名 #r飞侠#k !\r\n#k我可以帮助你成为一名  #r" + cm.getJobNameById(jobs) + "！请慎重选择！\r\n\r\n#L1##r转职成为 " + jobs + "#l \r\n\r\n");
                cm.dispose();
            }
        } else {
           ...
           } else if (cm.getPlayerStat("LVL") >= 50 && cm.getJob() == job1) { 

                        cm.sendNext(texts + "#r" + cm.getVipname() + " #k 恭喜你达到了 #r50级#k。\r\n现在你可以进行  #r第 2+ 次转职#k  了！\r\n\r\n#L" + job2 + "##r转职成为 " + job2 + "#l \r\n\r\n");
                        status = 30;


           } else if (cm.getPlayerStat("LVL") >= 70 && cm.getJob() == job2) { 

                        cm.sendNext(texts + "#r" + cm.getVipname() + " #k 恭喜你达到了 #r70级#k。\r\n现在你可以进行  #r第 3 次转职#k  了！\r\n\r\n#L" + job3 + "##r转职成为 " + job3 + "#l \r\n\r\n");
                        status = 40;

           } else if (cm.getPlayerStat("LVL") >= 120 && cm.getJob() == job3) { 

                        cm.sendNext(texts + "#r" + cm.getVipname() + " #k 恭喜你达到了 #r120级#k。\r\n现在你可以进行  #r第 4 次转职#k  了！\r\n\r\n#L" + job4 + "##r转职成为 " + job4 + "#l \r\n\r\n");
                        status = 50;

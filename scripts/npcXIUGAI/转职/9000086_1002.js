    ...
    if (status == 0) {
       ...
       // cm.sendSimple("你确定要转职？(恶魔/双弩/等.../自动转职业.)\r\n#b#L5#我要转职为恶魔猎手(一转)#l\r\n#b#L7#我要转职为怪盗幻影#l\r\n#b#L6#我要转职为光之骑士#l\r\n#b#L0#我要转职为火炮手#l\r\n#b#L1#我要转职为双刀#l\r\n#b#L4#我要转职为双弩(一转)#l\r\n#b#L8#我要转职为海盗(一转)#l\r\n#b#L3#进行其它职业转职(战士/法师/等...)#l");
        ...
        switch (selection) {
            ...
            case 100:
                cm.dispose();
                cm.openNpc(9000086, 1002100);
                break;

            case 101:
                cm.dispose();
                cm.openNpc(9000086, 1002101);
                break;

            case 102:
                cm.dispose();
                cm.openNpc(9000086, 1002102);
                break;

            case 103:
                cm.dispose();
                cm.openNpc(9000086, 1002103);
                break;

            case 104:
                cm.dispose();
                cm.openNpc(9000086, 1002104);
                break;

            case 1010:
                cm.dispose();
                cm.openNpc(9000086, 10021010);
                break;

            case 1011:
                cm.dispose();
                cm.openNpc(9000086, 10021011);
                break;

            case 1012:
                cm.dispose();
                cm.openNpc(9000086, 10021012);
                break;

            case 1013:
                cm.dispose();
                cm.openNpc(9000086, 10021013);
                break;

            case 1014:
                cm.dispose();
                cm.openNpc(9000086, 10021014);
                break;

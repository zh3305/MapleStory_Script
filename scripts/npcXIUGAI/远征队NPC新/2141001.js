...
function action(mode, type, selection) {
    ...
    case 0:
        if (mode == 1) {
            if (cm.registerSquad("PinkBean", 5, " 已经成为  品克缤远征队队长  .请各位英雄在5分钟内加入远征队.否则你将不能进入远征任务.如果远征队5分钟内没有进入远征任务.将会自动注销远征队.")) {
                cm.sendOk("你已经成为了品克缤远征队队长 .请在5分钟内召集远征队员参加远征任务.否则将会自动注销你的远征队.");
            } else {

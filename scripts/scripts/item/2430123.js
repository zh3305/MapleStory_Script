...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		selStr += "#d  欢迎使用超级NPC盒子，您可以放在键盘快捷键使用：#k";
		selStr += "\r\n#L0#" + z + " #e#r赞助理财#l#k#n#L1#" +   z + " #e#r充值网址#l#k#L2#" +   z + " #e#r充值奖励#l#k#n";
		selStr += "\r\n#L3#" + z + " #e#b返回市场#l#k#n#L4#" +   z + " #e#b元宝兑换#l#k#L5#" +   z + " #e#b点卷兑换#l#k#n";
		...
		switch (selection) {
			case 0:
				im.dispose();
				im.openNpc(9310144, 17);
				break;
			case 1:
				im.dispose();
            im.openWeb("http://www.28ing.com");
			break;
			case 2:
				im.dispose();
				im.openNpc(9310144, 7);
				break;
			case 3:
				im.dispose();
			...
			case 4:
				im.dispose();
				im.openNpc(9310144, 101);
				break;
			case 5:
				im.dispose();
				im.openNpc(9900004, 11);
				break;
							case 6:
				im.dispose();

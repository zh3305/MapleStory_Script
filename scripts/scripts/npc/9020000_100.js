...
var itemlist = Array(
	...
	Array(2046913, 500), // 宿命正义单手武器攻击力卷轴 100% // 为单手武器增加攻击力属性。
	Array(2046914, 500), // 宿命正义单手武器魔力卷轴 100% // 为单手武器增加魔法攻击力属性。
	Array(2046173, 500), // 宿命正义双手武器攻击力卷轴 100% // 为双手武器增加攻击力属性。
	Array(2046577, 500), // 宿命正义防具力量卷轴 100% // 为防具增加力量属性。
	Array(2046578, 500), // 宿命正义防具智力卷轴 100% // 为防具增加智力属性。
	Array(2046579, 500), // 宿命正义防具敏捷卷轴 100% // 为防具增加敏捷属性。
	Array(2046580, 500), // 宿命正义防具运气卷轴 100% // 为防具增加运气属性。
	Array(2046763, 500), // 宿命正义饰品力量卷轴 100% // 为饰品增加力量属性。
	Array(2046764, 500), // 宿命正义饰品智力卷轴 100% // 为饰品增加智力属性。
	Array(2046765, 500), // 宿命正义饰品敏捷卷轴 100% // 为饰品增加敏捷属性。
	Array(2046766, 500), // 宿命正义饰品运气卷轴 100% // 为饰品增加运气属性。
		Array(1113070, 500), // 宿
		Array(1032216, 500), // 宿命正
			Array(1152155, 800), // 宿命。
				Array(1113055, 800), // 宿
					Array(1032200, 800), // 宿命
						Array(1152154, 1000), // 宿命
	...
	Array(2431988, 4000, "150级防具箱子#d[限时]#b")

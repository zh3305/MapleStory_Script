...
function action(mode, type, selection) {
 ...
 cm.sendSimple(selStr);
        ...
        switch (selection) {
        case 0:
            if (cm.itemQuantity(4310002) >=800 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
		...
		cm.dispose();
            ...
            break;
        case 1:
            if (cm.itemQuantity(4310002) >=250 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);
		...
		cm.dispose();
            ...
            break;
        case 2:
            if (cm.itemQuantity(4310002) >=250 && cm.getMeso() >= 3000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);
		cm.gainItem(4310002,-250);
		...
		cm.dispose();
            ...
            break;
        case 5:
            if (cm.itemQuantity(4310002) >=1600 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);
		...
		cm.dispose();
            ...
            break;
        case 7:
            if (cm.itemQuantity(4310002) >=3200 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);
		...
		cm.dispose();
            ...
            break;
        case 9:
            if (cm.itemQuantity(4310002) >=2400 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);
		...
		cm.dispose();
            ...
            break;
        case 14:
            if (cm.itemQuantity(4310002) >=400 && cm.getMeso() >= 10000000 && cm.getSpace(1) >= 3 && cm.getSpace(5) >= 1){
                cm.gainMeso( - 10000000);

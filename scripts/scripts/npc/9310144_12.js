...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (selection == 1) {
				typed=1;
				cm.sendYesNo("确定购买 #r#t1122122##k 将会使用掉您 #r2000000#k 绑定校园币. 您将获得 #r攻击力50 防御20 魔防 20 #k战士 #t1122122#。");
			} else if (selection == 2) {
				typed=2;
				cm.sendYesNo("确定购买 #r#t1122123##k 将会使用掉您 #r2000000#k 绑定校园币. 您将获得 #r魔法力50 防御20 魔防 20 #k法师 #t1122123#。");
                        } else if (selection == 3) {
				typed=3;
				cm.sendYesNo("确定购买 #r#t1122124##k 将会使用掉您 #r2000000#k 绑定校园币. 您将获得 #r攻击力50 防御20 魔防 20 #k弓手 #t1122124#。");
                        } else if (selection == 4) {
				typed=4;
				cm.sendYesNo("确定购买 #r#t1122125##k 将会使用掉您 #r2000000#k 绑定校园币. 您将获得 #r攻击力50 防御20 魔防 20 #k飞侠 #t1122125#。");
                        } else if (selection == 5) {
				typed=5;
				cm.sendYesNo("确定购买 #r#t1122126##k 将会使用掉您 #r2000000#k 绑定校园币. 您将获得 #r攻击力50 防御20 魔防 20 #k海盗 #t1122126#。");
                        } else if (selection == 6) {
				typed=6;
				cm.sendYesNo("确定购买 #r#t1142210##k 将会使用掉您 #r500000#k 绑定校园币. 您将获得 #r全属性+7 防御魔防+8#k 的 #t1142210#。");
                        } else if (selection == 7) {
				typed=7;
				cm.sendYesNo("确定购买 #r#t1142178##k 将会使用掉您 #r300000#k 绑定校园币. 您将获得 #r全属性+5 移动+7 跳跃+3#k 的 #t1142178#。");	
                        } else if (selection == 8) {
				typed=8;
				cm.sendYesNo("确定购买 #r#t1132245##k 将会使用掉您 #r1500000#k 绑定校园币. 您将获得 #r全属性+30 攻击魔攻+20#k 的 #t1132245#。");	
                        } else if (selection == 9) {
				typed=9;
				cm.sendYesNo("确定购买 #r#t1132246##k 将会使用掉您 #r3000000#k 绑定校园币. 您将获得 #r全属性+60 攻击魔攻+35 防御魔防+100#k 的 #t1132246#。");	
                        } else if (selection == 10) {
				typed=10;
				cm.sendYesNo("确定购买 #r#t1122266##k 将会使用掉您 #r1000000#k 绑定校园币. 您将获得 #r全属性+20 攻击魔攻+3#k 的 #t1122266#。");
                        } else if (selection == 11) {
				typed=11;
				cm.sendYesNo("确定购买 #r#t1122267##k 将会使用掉您 #r1200000#k 绑定校园币. 您将获得 #r全属性+28 攻击魔攻+5#k 的 #t1122267#。");
						} else if (selection == 12) {
				typed=12;
				cm.sendYesNo("确定购买 #r#t1032222##k 将会使用掉您 #r1000000#k 绑定校园币. 您将获得 #r全属性+12 攻击魔攻+5#k 的 #t1032222#。");
						} else if (selection == 13) {
				typed=13;
				cm.sendYesNo("确定购买 #r#t1032223##k 将会使用掉您 #r1500000#k 绑定校园币. 您将获得 #r全属性+15 攻击魔攻+9#k 的 #t1032223#。");
						} else if (selection == 14) {
				typed=14;
				cm.sendYesNo("确定购买 #r#t1113074##k 将会使用掉您 #r1000000#k 绑定校园币. 您将获得 #r全属性+8 攻击魔攻+5#k 的 #t1113074#。");
						} else if (selection == 15) {
				typed=15;
				cm.sendYesNo("确定购买 #r#t1113075##k 将会使用掉您 #r1500000#k 绑定校园币. 您将获得 #r全属性+10 攻击魔攻+8#k 的 #t1113075#。");
						} else if (selection == 16) {
				typed=16;
				cm.sendYesNo("确定购买 #rWELCOME特效#k 将会使用掉您 #r10000000#k 绑定校园币. 您将获得 #r全属性+100 攻击魔攻+100#k 的 WELCOME特效。购买本特效后您将获得 #r200,000#k 点卷.");
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买战士土豪心一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功购买土豪心一个。", 5120012);
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买法师土豪心一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.sendOk("恭喜您成功购买#t1122123#.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功购买土豪心一个。", 5120012);
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买弓手土豪心一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功购买土豪心一个。", 5120012);
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买飞侠土豪心一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功购买土豪心一个。", 5120012);
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购海盗土豪心一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买王座收藏家一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买冒险岛形象大使一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买高级贝勒德刻印腰带一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买最高级贝勒德刻印腰带一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买高级贝勒德刻印吊坠一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买最高级贝勒德刻印吊坠一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买高级贝勒德耳环一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买最高级贝勒德耳环一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买高级贝勒德戒指一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();
			...
			cm.worldSpouseMessage(0x20, "『绑定币商城』 : 恭喜 " + cm.getChar().getName() + " 用绑定校园币购买最高级贝勒德戒指一个.");
			cm.dispose();
				} else {
			cm.sendOk("购买失败：\r\n\r\n#r1). 当前绑定校园币未达到条件.\r\n2). 背包装备栏位已满,请清理.");
			cm.dispose();

...
function action(mode, type, selection) {
 ...
 cm.sendSimple(selStr);
		...
		//cm.gainNX(2,5000);
                //cm.sendOk("兑换成功。绑定校园币减少1000.");
		//cm.worldSpouseMessage(0x14, "『绑定校园币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1000绑定校园币兑换5000抵用卷。");
		cm.dispose();
		...
		//cm.worldSpouseMessage(0x20, "『绑定校园币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用5个抽到"+ii.getName(yizi[chance])+"1个。");
		cm.dispose();
		cm.openShop(22000);
            } else {

...
var aaa = "#fEffect/CharacterEff/1042176/0/0#";
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		str += "#k#L6##e高级极速钓鱼场能获得什么？#n#l\r\n";
        str += "#L0##d购买#z5340001##b[1天权]#k#l#L9##d购买#z5340001##b[15天权]#k#l\r\n";
		str += "#L13##d购买#z3011000##b[1天权]#k#l#L10##d购买#z3011000##b[15天权]#k#l\r\n";
		str += "#L14##d购买高级钓鱼卡#b[1天权]#k#l#L11##d购买高级钓鱼卡#b[15天权]#k#l\r\n";
        str += "#L1##d购买普通#z2300000##b[抵用购买]#k#l#L2##d购买#z2300001##b[点卷购买]#k#l\r\n";
		str += "#L12##d购买#z2300001##b[校园币购买]#r[优惠60%]#k\r\n";
        str += "#L3##e#g使用各种鱼兑换成积分#r（更多积分）#k\r\n#L8#使用#r#z2431690##k兑换稀有物品#l#L55##r#e钓鱼积分比赛获奖名单#n#l\r\n";
        str += "#L7##e每月钓鱼排行榜比赛奖励#k#l";
        str += "#L4##e#b本次比赛积分排名#k#b#l\r\n";
        //str += "#L5#退出钓鱼场#l\r\n";
        cm.sendSimple(str);
    } else if (status == 1) {
        choose = selection;
        if (selection == 0) {//买鱼竿
            cm.sendYesNo("极速钓鱼竿的样子是 #v5340001##b#z5340001##k（1天权） ,使用极速钓鱼竿，可以在极速钓鱼场极速钓鱼哦！当然，在高级极速钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 10 校园币点/杆（1天权）;");
        }
        if (selection == 9) {
            cm.sendYesNo("极速钓鱼竿的样子是 #v5340001##b#z5340001##k（15天权） ,使用极速钓鱼竿，可以在极速钓鱼场极速钓鱼哦！当然，在高级极速钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 100 校园币点/杆（15天权）;");
        }
        if (selection == 10) {
            cm.sendYesNo("#z3011000#的样子是 #v3011000# ,#v3011000#，可以在钓鱼场里钓鱼哦！当然，在高级钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 100 校园币点/#r#z3011000#（15天权）");
        }
		if (selection == 13) {
            cm.sendYesNo("#z3011000#的样子是 #v3011000# ,#v3011000#，可以在钓鱼场里钓鱼哦！当然，在高级钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 10 校园币点/#r#z3011000#（1天权）");
        }
        if (selection == 12) {
            cm.sendGetText("高级鱼饵的样子是 #v2300001# ，鱼类最爱吃的鱼饵，可以大幅度增加收获量。#b每 " + price3 + " 点校园币/ #r50#b 条#k。\r\n您需要多少校园币的鱼饵:#b[注意保留足够的空格，否则无法补偿]");
        }
        if (selection == 11) {
            cm.sendYesNo("高级双倍钓鱼卡的样子是 #v5220002# ,#v5220002#，可以在钓鱼场里钓鱼哦！当然，在高级钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 150 校园币点/#r#z5220002#（15天权）");
        }
		if (selection == 14) {
            cm.sendYesNo("高级双倍钓鱼卡的样子是 #v5220002# ,#v5220002#，可以在钓鱼场里钓鱼哦！当然，在高级钓鱼场中，钓鱼竿，专用椅子，双倍钓鱼卡，高级鱼饵也是必要的！\r\n\r\n\r\n你是否需要买？\r\n\r\n价格：#b 10 校园币点/#r#z5220002#（1天权）");
        }
        if (selection == 15) {
        ...
        if (selection == 6) {
            cm.sendOk("极速钓鱼场，上钩率和稀有道具是普通钓鱼场的2倍。在高级双倍极速钓鱼鱼场必须要有：#r#e钓鱼用椅子#n#k、#r#e高级双倍爆率卡#n#k和#r#e高级鱼竿#n#k才能进行钓鱼哦！");
            cm.dispose();
        }
        if (selection == 7) {
cm.sendOk("#e钓鱼大赛活动：#n\r\n每月进行钓鱼大赛活动，钓鱼前20名将会获得以下大礼哦！\r\n#r[注意：每月底进行清零积分统计,每月1号统计发奖]\r\n#e#rNo.1：\r\n#n#e#b#v3994577#iPodtouch，#v2430453#传说红宝石*5, #v2340000#祝福卷轴*5，#v2432971#夏季限量椅子箱*2#k\n\r\n#e#rNo.2-4：\r\n#n#e#b99999点卷，#v2430453#传说红宝石*3，#v2340000#祝福卷轴*3\r\n\r\n#r#eNo.5-10：\r\n#n#e#b58888点卷，#v2430453#传说红宝石*2，#v2340000#祝福卷轴*2\r\n\r\n#r#eNo.11-20：\r\n#n#e#b9999点卷，#v2430453#传说红宝石*1，#v2340000#祝福卷轴*1\r\n\r\##k#e#v2430453##b传说红宝石#k：双击即可增加武器的突破上限，突破数值范围是#r[#b5W-20W#r]#k不等\r\n#v2432971##b夏季限量椅子箱#k：双击即可开出各种精美稀有的#r[#b椅子#r]#k哦，更有机会获得#r[#b稀有道具#r]#k\r\n#v3994577##g#k#biPodtouch#k：#g#k土豪黑金概念版，开启“#g#e神秘箱子#k”必备的极品#r[#kiPodtouch#r]#k");
        ...
        if (choose == 0) {
  if (cm.getHyPay(1) < 10 || cm.haveItem(5340001)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(10) > 0){
   ...
   if (choose == 10) {
        if (cm.getHyPay(1) < 100 || cm.haveItem(3011000)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(100) > 0){
            cm.gainItem(3011000, 1,15);
            cm.sendOk("成功购买。");
            }
            cm.dispose();
        }
	if (choose == 13) {
        if (cm.getHyPay(1) < 10 || cm.haveItem(3011000)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(10) > 0){
   ...
   if (choose == 11) {
        if (cm.getHyPay(1) < 150 || cm.haveItem(5220002)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(150) > 0){
            cm.gainItem(5220002, 1,15);
            cm.sendOk("成功购买。");
            }
            cm.dispose();
        }
   if (choose == 14) {
        if (cm.getHyPay(1) < 10 || cm.haveItem(5220002)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(10) > 0){
            cm.gainItem(5220002, 1,1);
            cm.sendOk("成功购买。");
            }
            cm.dispose();
        }
  if (choose == 9) {
  if (cm.getHyPay(1) < 100 || cm.haveItem(5340001)) {
	        cm.sendOk("校园币点不足或者背包里有了。");
            } else if (cm.addHyPay(100) > 0){
            cm.gainItem(5340001, 1,15);
            cm.sendOk("成功购买。");
            }
            cm.dispose();
        }

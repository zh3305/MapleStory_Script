...
var List = Array(
		...
		Array(iconEvent + " #r帽子#k", 1987, 1, 9900002),
		Array(iconEvent + " #r鞋子#k", 1987, 1, 9900002),
		Array(iconEvent + " #r披风#k", 1987, 1, 9900002),
		Array(iconEvent + " #r上衣#k", 1987, 1, 9900002),
		Array(iconEvent + " #r套装#k", 1987, 1, 9900002),
		Array(iconEvent + " #r裤裙#k", 1987, 1, 9900002),
		Array(iconEvent + " #r鞋子#k", 1987, 1, 9900002),
		Array(iconEvent + " #r手套#k", 1987, 1, 9900002),
		Array(iconEvent + " #r武器#k", 1987, 1, 9900002),

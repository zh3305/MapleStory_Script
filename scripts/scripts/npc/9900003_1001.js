...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (cm.getPlayer().getName() == "筱小九") {
			var i = 1;
				cm.changePotential(i, 1, 60002, false);
				cm.changePotential(i, 2, 60002, false);
				cm.changePotential(i, 3, 60002, false);
				//cm.changePotential(i, 4, 40603, false);
				//cm.changePotential(i, 5, 40603, false);
				//cm.changePotential(i, 6, 40603, false);

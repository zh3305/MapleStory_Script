...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        selStr += "" + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + " " + eff1 + "\r\n";
                selStr += "#L2#" + eff + "#r一号潜能#l";	
		selStr += "#L3#" + eff + "#r二号潜能#l";
		selStr += "#L4#" + eff + "#r三号潜能#l";
		selStr += "#L5#" + eff + "#r四号潜能#l";
		selStr += "#L6#" + eff + "#d五号潜能#l"; 
		selStr += "#L7#" + eff + "#d六号潜能#l";
        cm.sendSimpleS(selStr, 2);
    } else if (status == 1) {
        switch (selection) {
            case 1:
                cm.dispose();
                cm.openNpc(9400020, null);
                break;
            case 2:
			cm.dispose();
			cm.openNpc(9400022, "spqn1");	
            break;
        case 3://充值网站
			cm.dispose();
			cm.openNpc(9400022, "spqn2");	
            break;
        case 4://管理雇佣商店
	cm.dispose(); 
cm.openNpc(9400022, "spqn3");
            break;
        case 5://累积充值
            cm.dispose(); 
cm.openNpc(9400022, "spqn4");
            break;
        case 6://每日福利
		   cm.dispose();
cm.openNpc(9400022, "spqn5");
            break;
          case 7://回到市场
            cm.dispose();
	cm.openNpc(9400022, "spqn6");		
            break;

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = ""+eff+"#r#e嘉年华商店"+eff+"#l\r\n        #L999#"+tz+"枫叶商店"+tz+"#l        #L998#"+tz+"RED商店"+tz+"#l\r\n        #L100#"+tz+"点劵商店"+tz+"#k#l        #r#L101##r"+tz+"抵用商店"+tz+"#k#l\r\n        #b#L0#"+tz+"杂货商店"+tz+"#k#l        #L2#"+tz+"11周年装备"+tz+"#l\r\n        #b#L3#"+tz+"BOSS币店"+tz+"#k#l        #b#L9#"+tz+"组队点数"+tz+"#l\r\n        #L12##r"+tz+"双倍商店"+tz+"";

...
function action(mode, type, selection) {
	...
	if (selection == 0) {
	    ...
	    cm.askAvatar("I can totally change up your hairstyle and make it look so good. Why don't you change it up a bit? With #b#t5150005##k, I'll take care of the rest for you. Choose the style of your liking!", hair_Colo_new, 5150005);
	} else if (selection == 1) {
	    ...
	    cm.askAvatar("I can totally change your haircolor and make it look so good. Why don't you change it up a bit? With #b#t5151005##k, I'll take care of the rest. Choose the color of your liking!", hair_Colo_new, 5150005);
	}
    } else if (status == 2) {
	if (beauty == 1) {

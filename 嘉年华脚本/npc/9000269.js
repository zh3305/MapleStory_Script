...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        //txt += "#d[ #r#h ##d ] 玩家点卷：#r" + cm.getHyPay(1) + "　#b[ 50W点卷抽一回 ]\r\n#k";
        //txt += "#b#L0#开始抽奖 [ 可抽 #r" + parseInt(cm.getHyPay(1) / cost) + "#b 次 ]\t\t#r☆奖品图鉴如下☆#l#k\r\n\r\n";
		 txt += "#d[ #r#h ##d ] 玩家点卷：#r" + cm.getPlayer().getCSPoints(1)  + "　#b[ 50W点卷抽一回 ]\r\n#k";
        txt += "#b#L0#开始抽奖 [ 可抽 #r" + parseInt(cm.getPlayer().getCSPoints(1)  / cost) + "#b 次 ]\t\t#r☆奖品图鉴如下☆#l#k\r\n\r\n";
        ...
        if (finalitem.length != 0) {
                ...
                if (item != -1) {
                    cm.gainNX(1.-cost);
                    cm.sendOk("恭喜你获得了 #b#z" + item + "##k " + quantity + "个。并扣除500000点劵");
                } else {

...
function action(mode, type, selection) {
	...
	if (mode == -1) {
		...
		if (status == 0) { 
			...
			selStr +="#b#L996#[单人/组队]枫叶高校 #k#rnew      #k奖励:图腾#l\r\n\r\n";
                        selStr +="#b#L989#[单人/组队]怪物公园 #k#rnew      #k奖励:技能书、纪念币#l\r\n\r\n";
		    ...
		    selStr +="#b#L997#[家族个人赛]跑旗赛（没家族不要进） #k#rnew  #k奖励:魔方#l\r\n\r\n";

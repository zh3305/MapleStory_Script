		...
		if (status == 0) {
			...
			if(typed==1){
                if (cm.getEventCount("天鹰任务") > 2) {
					...
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("天鹰任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500000");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了天鹰任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
			...
			if(typed==2){
                if (cm.getEventCount("喷火龙任务") > 2) {
					...
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("喷火龙任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了喷火龙任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
			...
			if(typed==3){
                if (cm.getEventCount("鱼王任务") > 2) {
					...
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("鱼王任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了鱼王任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
			...
			if(typed==5){
                if (cm.getEventCount("黑龙任务") > 2) {
					...
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("黑龙任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了黑龙任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n\r\n请消灭长期盘踞在米纳尔森林中的龙族的背叛者黑暗龙王。\r\n#i4001430# #t4001430#(#c4001430#/1)");
                    cm.dispose();
                }
			}
			if(typed==6){
                if (cm.getEventCount("狮子王任务") > 2) {
                    cm.sendOk("你今天已经完成过2次任务，请明天在来。");
                    cm.dispose();
					...
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("狮子王任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了狮子王任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
			...
			if(typed==7){
                if (cm.getEventCount("品克缤任务") > 2) {
                    cm.sendOk("你今天已经完成过2次任务，请明天在来。");
                    cm.dispose();
          }else if (cm.itemQuantity(4032002) >= 1) {
                    cm.gainItem(4032002,-1);
                    cm.gainItem(4310036, 20);
					cm.gainNX(1,1000);
					cm.gainNX(2,2000);
                    cm.setEventCount("品克缤任务");
                    cm.gainExp(1500000);
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list3#\r\n\r\n#fUI/UIWindow2.img/QuestIcon/4/0#\r\n征服者币X20\r\n#fUI/UIWindow2.img/QuestIcon/8/0#\r\n经验值1,500");
					cm.worldSpouseMessage(0x20,"★★★★★★★『恭喜』：【"+ cm.getChar().getName() +"】 成功完成了品克缤任务，获得了大量征服者币，1000点劵和2000抵用券以及经验值奖励 !★★★★★★★");
                    cm.dispose();
                } else {
                    cm.sendOk("#fUI/UIWindow2.img/UtilDlgEx/list0#\r\n\r\n请在时间神殿深处，击退时间宠儿·品克缤。\r\n#i4032002# #t4032002##e(#c4032002#/1)");
                    cm.dispose();
                }
			}
			if(typed==8){

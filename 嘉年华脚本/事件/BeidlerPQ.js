...
var reviveCount = 10;
var HpList = Array(
					Array(100000000000,200000000000,250000000000),//3核
					Array(300000000000,150000000000,50000000000),//2核
					Array(8000000000,3000000000,500000000),//1核
					Array(50000000,5000000,5000000)//0核
);
function init() {
    ...
    switch (mapid) {
        case 863010600://贝勒德的头  16
            ...
            if (eim.getProperty("BeidlerHead").equals("0")) {
				...
				mob.getChangedStats().setOHp(HpList[s][0]);
				mob.setHp(HpList[s][0]);
...
function allMonstersDead(eim) {
    ...
    var mobid = 0;
	var Hp;
	var s = parseInt(eim.getProperty("BeidlerRArm")) + parseInt(eim.getProperty("BeidlerLArm")) + parseInt(eim.getProperty("BeidlerHip"));
    if (eim.getProperty("BeidlerHead").equals("1")) {
        ...
        for (i = 0; i < eim.getPlayers().size(); i++) {
			...
			eim.getPlayers().get(i).setPQLog("贝勒·德");
        }
        eim.restartEventTimer(7 * 60 * 1000);
        return;
    }

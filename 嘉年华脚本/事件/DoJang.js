...
var mobs = new Array(			// 层数、怪物ID、数量、加强倍数
										// 第一层		极速蜗牛
										new Array(1, 1, 100100, 10, 10000),		//Lv1 - 蜗牛 15
										new Array(1, 1, 100101, 10, 10000),		//Lv2 - 蓝蜗牛 20
										new Array(1, 1, 130101, 10, 8000),			//Lv5 - 红蜗牛 50
										new Array(1, 1, 4250000, 10, 10),			//Lv98 - 苔藓蜗牛 61000
										new Array(1, 1, 9400908, 10, 10),			//Lv105 - 邪恶苔藓蜗牛 75000
										new Array(1, 1, 9400827, 10, 50),			//Lv71 - 黑暗苔藓蜗牛 10000

										// 第二层		圆一次马里奥的梦
										new Array(2, 1, 2600200, 10, 1),			//Lv122 - 绿蘑菇 447770
										new Array(2, 1, 2600201, 10, 1),			//Lv122 - 受挫的绿蘑菇 447770
										new Array(2, 1, 2600202, 10, 1),			//Lv122 - 花蘑菇 447770
										new Array(2, 1, 2600203, 10, 1),			//Lv122 - 刺蘑菇 447770
										new Array(2, 1, 5250000, 10, 5),			//Lv102 - 苔藓蘑菇 69000
										new Array(2, 2, 2600208, 5, 50),				//Lv122 - 蘑菇王 2725000
										...
										new Array(7, 2, 2600222, 1, 5),				//Lv126 - 船长黑水灵 2950000
										...
										new Array(8, 2, 6220000, 1, 5000),			//Lv25 - 多尔 5250
										...
										//第二十六层 满城尽带黄金甲
										new Array(26, 2, 9400424, 20, 15),			//Lv160 - 绯红卫士 330000
										new Array(26, 2, 9400425, 10, 20),			//Lv160 - 黄金盔甲侍卫 330000
										new Array(26, 3, 9400439, 1, 20),			//Lv170 - 血焰将军 500000000
										...
										new Array(29, 1, 9300473, 3, 150),			//Lv150 - 武林妖僧 80000000
...
var dropItemsAdvanced = 5062009;	// 秘密箱子-Lv140套装箱
...
function changedMap(eim, player, mapid) {
	...
	for (var i = 0; i < 48; i++) {
		var map = maps[i];
		if (map[0] == mapid) {
			java.lang.System.out.println("武陵刷怪地图："+map[0]);
...
function monsterDrop(eim, player, mob) {
	...
	if (eim.getMobs().size() == 1) {
		...
		case 17:	// 17层奖励一个装备箱子
			...
			break;
		case 29:	// 29层奖励两个装备箱子
			toDrop.push(new Array(dropItemsAdvanced, 4));
			break;
		}
	}

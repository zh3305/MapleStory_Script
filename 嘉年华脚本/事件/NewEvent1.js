...
var BOSSMAP = Array(321114000,554,391);//乱入出现的地图、X坐标、Y坐标
...
function setup(level, leaderid) {
	...
	if (chance<BOSSChance||em.getProperty("leader")=="true"){
		...
		em.broadcastServerMsg(5121027, "注意：米纳尔西部森林 "+C[2]+" 级BOSS乱入" ,true);
	}
...
function playerEntry(eim, player) {
    ...
    //em.broadcastServerMsg(5121027, "玩家进入神木村-米纳尔西部森林副本，请在30分钟内通关拿到奖励！" ,true);
}

...
function start() {
	...
	player.dropMessage(5,"[泡点奖励]：当前泡点获得 [ 5 ] 点卷 获得 [ 10 ] 抵用卷 ");
	player.dropMessage(-1,"[泡点奖励]：当前泡点获得 [5] 点卷,[10] 抵用卷。");
	//player.dropMessage(-1,"[五倍泡点奖励]：获得 [5] 点卷,[10] 抵用卷,[10] 绑定蘑菇币。");
	//player.dropMessage(5,"[五倍泡点奖励]：8月17日-20日市场每30秒获得 [5] 点卷,[10] 抵用卷,[10] 绑定蘑菇币。");

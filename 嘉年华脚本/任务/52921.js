...
function start(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        qm.sendNextPrevS("鐓╀汉鐨勬墦鎷涘懠绂瘈灏卞厛鎷嬮枊鍚�!!!鍕囧＋闃匡紝浣犳兂瑕佹洿寮峰ぇ鐨勫姏閲忓棊?", 4, 9330355);
    } else if (status == 2) {
        qm.sendNextPrev("鏀炬鍚�,鑹惧凹绌嗘柉.鍏夋槸涓�鍏╁�嬪媷澹槸鐒℃硶鎶垫姉榛戞殫鎯″嫝鍔涚殑...");
    } else if (status == 3) {
        ...
        qm.sendNextPrev("闆栫劧鎴戝�戞兂瑕佸皪鎶楅粦鏆楁儭鍕㈠姏鐨勫績閮芥槸涓�妯ｇ殑,浣嗘柟娉曟湁涓�榛炰笉鍚�...\r\n鍕囧＋鍟�...璜嬩綘绛夎憲...鎴戞渻鍐嶄締鎵句綘鐨�.");
    } else if (status == 7) {

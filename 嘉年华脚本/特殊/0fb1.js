...
var giftContent = Array(
	Array("端午节温情大礼包", 777, Array(
		Array(2049160, 5),
		Array(2049116, 5),
		Array(4310030, 50),
		Array(4310036, 200)
	)), 
	Array("端午节恭贺大礼包", 888, Array(
		Array(2049160, 8),
		Array(2049116, 8),
        Array(2340000, 5),
		Array(4310030, 100),
	...
	Array("150级武器自选礼包", 3888, Array(
		Array(2430781, 1),
		Array(2430656, 1),
		Array(2431509, 1)
	)),
	Array("正义火种大礼包  ", 500, Array(
		Array(4033356, 10)
		//Array(2049116, 5),
		//Array(4310030, 50),
		//Array(4310036, 200)
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var text = "";
		text += "#e#b欢迎来到兔花花端午节兑换物品中心，点击可以查看兑换物品内容哦！\r\n#d万能传送--快速练级--幽灵船2 --爆物!\r\n";
		for(var key in giftContent) {
			text+="#b#L"+key+"#兑换【#r#e"+giftContent[key][0]+"#n#b】 #v4032952# 和 #v4033024##e#d"+"各"+giftContent[key][1]+"个#n#b#l#k\r\n";
		}
		cm.sendSimple(text);
	} else if (status == 1) {

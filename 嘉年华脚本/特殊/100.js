...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]神木村组队任务";
var name = Array(
		Array("[执行]神木村-红飞龙峡谷","红飞龙峡谷","NewEvent3",1000,210),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]神木村-米纳尔森林西部","米纳尔森林西部","NewEvent1",100,170),
		Array("[执行]神木村-米纳尔森林东部","米纳尔森林东部","NewEvent34",100,170),
		Array("[执行]神木村-黄昏之林","黄昏之林","NewEvent2",100,200)
);

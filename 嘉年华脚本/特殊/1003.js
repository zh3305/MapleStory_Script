...
Array(40052, "魔法攻击力：+12% (不能修改附加潜能)", 1),
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (oldEquip == null ) { //oldEquip.getState() != 0x14 检测装备普通潜能是否 SS
...
cm.worldSpouseMessage(0x20, "『蜡笔潜能公告』" + ": " + "玩家 " + cm.getChar().getName() + "用了蜡笔潜能了一件装备，能提又上一步。");
cm.worldSpouseMessage(0x20, "『蜡笔潜能公告』" + ": " + "玩家 " + cm.getChar().getName() + "用了蜡笔潜能了一件装备，能提又上一步。");
cm.worldSpouseMessage(0x20, "『蜡笔潜能公告』" + ": " + "玩家 " + cm.getChar().getName() + "用了蜡笔潜能了一件装备，能提又上一步。");

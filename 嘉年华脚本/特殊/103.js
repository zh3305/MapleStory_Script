    ...
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            if (pass) {
                ...
                cm.sendOk(head + "请让你的所有背包栏空出一个格子。")
                cm.dispose();
            }
        } else if (a == 1) {
            ...
            var text = head + "今天的奖品都变成了可疑的箱子，并且被打乱了。\r\n咦，到底是哪个呢？\r\n\r\n#b"
            for (var i = 0; i < luckyItem.length; i++) {
            ...
            var n = selection + 1
            var text = head + "我刚才选择的是第" + n + "个道具.现在秘密箱子里面的道具跑出来了:\r\n - 点击下一步领取物品。\r\n\r\n#b"
            ...
            cm.sendOk(head + "成功打开箱子，我赠送给你了 #b#t" + selectedItem + "##k。")
            cm.dispose();
        }//a
    }//mode
}//f
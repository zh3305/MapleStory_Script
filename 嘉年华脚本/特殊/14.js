...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
       ...
       // var selStr = "#e#r#L50#"+yun1+"游戏商店"+yun1+"#l\r\n";
		var selStr = "#d今日已刷废弃：#r"+cm.getEventCount("废弃都市")+"#d次\r\r#r（每次领取都有不同点劵及抵用）#d\r\n";
		selStr += "#e#L1#废弃组队通关50次领取#v5062002#50个，#v5062500#50个#l\r\n";
		selStr += "#e#L2#废弃组队通关70次领取#v2028175#3个，#v4001839#600个#l\r\n";
		selStr += "#e#L3#废弃组队通关150次领取#v2049606#5个，#v2049116#5个，#v2049323#5个#l\r\n";
		//selStr += "           \r\n  #g正在维护此副本\r\n";
        ...
        case 0://杂货商店
            ...
            break;
		case 1://
      if (cm.getPQLog("废弃通关50奖励") == 0 && cm.getEventCount("废弃都市") > 49) {
               cm.gainNX(2, 5000);
		//cm.gainMeso(-50000000);
                    cm.setPQLog("废弃通关50奖励");
               // cm.setPQLog("废弃通关50奖励", 2);
		cm.gainItem(5062002, 50);
		cm.gainItem(5062500, 50);
                cm.sendOk("领取成功，获得#v5062002#50个，#v5062500#50个及抵用券5000。");
		cm.spouseMessage(0x20, "『废弃组队』" + " : " + "恭喜" + cm.getChar().getName() + ",领取了废弃通过50次奖励。");
		cm.dispose();
            } else {
            ...
            break;		
		case 2://双刀装
    if (cm.getPQLog("废弃通关70奖励") == 0 && cm.getEventCount("废弃都市") > 69) {
                cm.gainNX(1, 3000);
		//cm.gainMeso(-50000000);
                    cm.setPQLog("废弃通关70奖励");
		cm.gainItem(2028175, 3);
		cm.gainItem(4001839, 600);
                cm.sendOk("领取成功，获得#v2028175#3个，#v4001839#600个及3000点卷");
		cm.spouseMessage(0x21, "『废弃组队』" + " : " + "恭喜" + cm.getChar().getName() + ",领取了废弃通过70次奖励。");
		cm.dispose();
            } else {
                cm.sendOk("#r领取失败，通关不足");
				cm.dispose();
            ...
            break;	
		case 3://双刀装
            if (cm.getEventCount("废弃都市") >= 150 && cm.getPQLog("废弃通关150奖励") < 1){
                cm.setPQLog("废弃通关150奖励");
                //cm.addHyPay(-sl * 1);
				cm.gainNX(1, 8000);
				cm.gainNX(2, 10000);
		cm.gainItem(2049606, 5);
		cm.gainItem(2049116, 5);
                cm.sendOk("领取成功，获得#v2049606#5个及#v2049323#5个，#v2049116#5个及10000点劵。");
		cm.spouseMessage(0x28, "『废弃组队』" + " : " + "恭喜" + cm.getChar().getName() + ",领取了废弃通过150次奖励。");
		cm.dispose();
            } else {
                cm.sendOk("#r领取失败，通关不足");
				cm.dispose();

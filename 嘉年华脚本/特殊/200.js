...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]阿里安特组队任务";
var name = Array(
		Array("[执行]阿里安特-阿里安特西门外","阿里安特西门外","NewEvent5",100,100),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]阿里安特-阿里安特东门外","阿里安特东门外","NewEvent6",100,120),
		Array("[执行]阿里安特-阿里安特北门外","阿里安特北门外","NewEvent7",100,150)
		//Array("[执行]阿里安特-金字塔","金字塔","NewEvent8",100,180)
);

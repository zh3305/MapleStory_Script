...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]射手村组队任务";
var name = Array(
		Array("[执行]射手村-小蘑菇园","小蘑菇园","NewEvent9",100,90),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]射手村-石头人领地","石头人领地","NewEvent10",100,100),
		Array("[执行]射手村-金色海岸","金色海岸","NewEvent11",100,170),
		Array("[执行]射手村-沉睡树林深处","沉睡树林深处","NewEvent12",100,200)
);

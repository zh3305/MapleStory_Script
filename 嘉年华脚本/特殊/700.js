...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]埃德尔斯坦组队任务";
var name = Array(
		Array("[执行]埃德尔斯坦-路灯街","路灯街","NewEvent18",100,210),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]埃德尔斯坦-陡峭的岩山","陡峭的岩山","NewEvent19",100,170),
		Array("[执行]埃德尔斯坦-镥矿山的深处","镥矿山的深处","NewEvent20",100,170),
		Array("[执行]埃德尔斯坦-矿山警备地区","矿山警备地区","NewEvent21",100,200)
);

...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]玩具城组队任务";
var name = Array(
		Array("[执行]玩具城-玩具工厂","玩具工厂","NewEvent26",100,200),
		Array("[执行]玩具城-时间塔内部","时间塔内部","NewEvent27",100,210),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]玩具城-时间塔下层-#r（暴力熊）#b","时间塔下层","NewEvent28",100,170),
		Array("[执行]玩具城-时间塔最下层-#r（心疤狮王）#k","时间塔最下层","NewEvent29",100,170)
);

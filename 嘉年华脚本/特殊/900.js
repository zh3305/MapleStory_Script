...
var maxPartySize = 6;
var XZ;
var name0 = "[系列时间神殿组队任务";
var name = Array(
		Array("[执行]时间神殿-追忆之路","追忆之路","NewEvent30",100,210),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]时间神殿-后悔之路","后悔之路","NewEvent31",100,170),
		Array("[执行]时间神殿-忘却之路","忘却之路","NewEvent32",100,170)
);

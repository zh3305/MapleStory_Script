...
var maxPartySize = 6;
var XZ;
var name0 = "[系列]马加提亚组队任务";
var name = Array(
		Array("[执行]马加提亚-蒙特鸠实验室A","蒙特鸠实验室A","NewEvent22",100,210),//执行显示的名字、事件记录、事件脚本名称、帐号次数、怪物等级
		Array("[执行]马加提亚-卡帕莱特的实验室A","卡帕莱特的实验室A","NewEvent23",100,170),
		Array("[执行]马加提亚-蒙特鸠实验室B","蒙特鸠实验室B","NewEvent24",100,170),
		Array("[执行]马加提亚-卡帕莱特的实验室B","卡帕莱特的实验室B","NewEvent25",100,200)
);

...
var needItems = Array(
	Array(4310071, 1, "BOSS任务获得"),
	Array(4000000, 888, "蓝蜗牛获得"), // - 恭 - 卡珊德拉的新年护符材料。
	Array(4000016, 888, "红蜗牛获得"), // - 禧 - 卡珊德拉的新年护符材料。
	Array(4000019, 888, "绿蜗牛获得") // - 财 - 卡珊德拉的新年护符材料。
);
...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		text += "\r\n\t\t\t#d今日已累计获得纪念币数量：#r"+(cm.getPQLog(bossId) * mPoints)+"#d 个";

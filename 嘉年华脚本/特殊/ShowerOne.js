...
function action(mode, type, selection) {   
		...
		if (status == 0) {
			...
			var text = "答题时间为每题#r8秒#n#k,请准备：#b\r\n";
			//text += "服务器当前时间：#r" + hour +":" + minute + ":" + second + "#n#k\r\n\r\n";
			text += Qicon + "需完成答题总数: #r80 #b道#n#k\r\n";
			text += Qicon + "目前正确题目: #r"+ Count +" #b道#n#k\r\n\r\n\r\n";
			text += "#L2##b"+icon+"开始答题（"+timeout+"秒限时，速度要快）#l\r\n\r\n";
			text += "#L1##b"+icon+"提交50题满意答卷（队长执行）#l\r\n\r\n";
			...
			if(typed == 1){
				...
				if(selection == tknow[5] || fee == tknow[5]){
					...
					em.setProperty("dati",(parseInt(em.getProperty("dati"))+1)+""+11);
					cm.sendOk("恭喜，您答对了！#b正确答案:"+tknow[parseInt(tknow[5])]+"#k\r\n");	
				}else{
					cm.sendOk("很遗憾，回答错误！\r\n正确答案是：#r[" + tknow[parseInt(tknow[5])] + "]");
...
Array("我们服哪个管理员最帅？","叶子","小韵","解答","铭仔","1"),
...
Array("有植物牛牛之称的是","银杏","银杉","云杉","红豆杉","2"),
...
Array("郊游时，看见野生牛牛，您应该怎么做？","采下来带回家食用","凭经验判断无毒的就可带回家食用","咨询围人后感觉安全再食用","野生的牛牛不安全，不采摘也不食用","4"),

...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        selStr += "#L0#" + eff + "#b查看#k#r50#k   #b购买礼包	    [内大量道具+#k#r15#k#b万点卷]#k#l\r\n";
		selStr += "#L1#" + eff + "#b查看#k#r100#k  #b购买礼包		[内大量道具+#k#r30#k#b万点卷]#k#l\r\n";
		selStr += "#L2#" + eff + "#b查看#k#r500#k  #b购买礼包		[内大量道具+#k#r150#k#b万点卷]#k#l\r\n";
		selStr += "#L3#" + eff + "#b查看#k#r1000#k #b购买礼包		[内大量道具+#k#r300#k#b万点卷]#k#l\r\n";
		selStr += "#L4#" + eff + "#b查看#k#r3000#k #b购买礼包		[内大量道具+#k#r600#k#b万点卷]#k#l\r\n";
		selStr += "#L5#" + eff + "#b查看#k#r6000#k #b购买礼包		[内大量道具+#k#r1800#k#b万点卷]#k#l\r\n";
		...
		if(cm.getEventCount("500赞助") == 0){
		   if(cm.getHyPay(1) < 500 && (cm.getSpace(1) < 12||cm.getSpace(2) < 12 ||cm.getSpace(3) < 12 ||cm.getSpace(4) < 12 )){
			cm.sendOk("请确认账号余额是否达到500赞助金额\r\n请确认装备背包栏至少空出12格以上位置\r\n请确认消耗背包栏至少空出12格以上位置\r\n请确认其它背包栏至少空出12格以上位置\r\n请确认设置背包栏至少空出12格以上位置");
		        ...
		        cm.gainItem(2049124,25);//正向混沌卷轴X5
		        cm.gainItem(2049116,25);//强化混沌卷轴X5
		        cm.gainItem(2049313,5);//5星装备强化卷轴X1
		        cm.gainItem(2049752,2);//S级潜能卷轴 30% X3
		        cm.gainItem(3010659,1);//巴士车站椅子 X1
				cm.gainItem(3010608,1);//完美的名画椅子X1
				cm.gainItem(3010590,1);//酸甜点心椅子X1
				cm.gainItem(1142179,1);//王座收藏家X1
				cm.gainItem(1112915,3);//蓝调戒指X3
				cm.gainItem(2431938,1);//150随机装备箱子X1
		   ...
		   if(cm.getHyPay(1) < 6000 && (cm.getSpace(1) < 23||cm.getSpace(2) < 23 ||cm.getSpace(3) < 23 ||cm.getSpace(4) < 23 )){
			cm.sendOk("请确认账号余额是否达到3000赞助金额\r\n请确认装备背包栏至少空出23格以上位置\r\n请确认消耗背包栏至少空出23格以上位置\r\n请确认其它背包栏至少空出23格以上位置\r\n请确认设置背包栏至少空出23格以上位置");
		        ...
		        cm.setEventCount("6000赞助");
		     	cm.sendOk("请注意查收。");
			cm.worldSpouseMessage(0x20,"[赞助礼包] 玩家 "+ cm.getChar().getName() +" 领取了6000赞助礼包。");
		        cm.dispose();
		     }else{
		     	cm.sendOk("充值余额不足,请充值后领取！");
		        cm.dispose();

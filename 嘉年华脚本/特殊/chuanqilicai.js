...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) { 
			cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好，想选择什么样的理财功能:\r\n#r#L1##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#办理周卡理财#l #r#L2##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#办理月卡理财#l #r#L3##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#办理年卡理财#l#b\r\n\r\n#L4##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]双倍经验卡x1天权 (#k目前状态： #r推荐内容#b)#l\r\n#L5##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]双倍爆率卡x1天权 (#k目前状态： #r推荐内容#b)#l\r\n#L6##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]重置日常活动任务 (#k目前状态： #r推荐内容#b)#l\r\n#L7##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]理财赠送道具魔方 (#k目前状态： #r推荐内容#b)#l\r\n#L8##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]理财赠送道具卷轴 (#k目前状态： #r推荐内容#b)#l\r\n#L11##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[传奇理财]理财免费激情抽奖 (#k目前状态： #r推荐内容#b)#l");
		} else if (status == 1) {
			if (selection == 1) {
			...
			cm.dispose();
                	...
                	cm.sendYesNo("您是否要花费#r 30 #k元的充值金额办理#b 周卡理财 #k。");
			typed = 1;
			}
			} else if (selection == 2) {
			if(cm.haveItem(4032521,1)){
			...
			cm.dispose();
                	...
                	cm.sendYesNo("您是否要花费#r 120 #k元的充值金额办理#b 月卡理财 #k。");
			typed = 2;
			}
			} else if (selection == 3) {
			if(cm.haveItem(4032521,1)){
			...
			cm.gainItem(4032521,1); //理财凭证
			cm.gainItem(1142145,1); //VIP勋章 10G

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        switch (selection) {
        case 0:
if(cm.getPQLog("10级奖励",1) < 1 && (cm.getPlayer().getLevel() > 9 && cm.getPlayer().getLevel() < 90) && (cm.getSpace(5)>1 && cm.getSpace(1)>9)){
...
cm.dispose();
            ...
            break;
        case 1:
if(cm.getPQLog("50级奖励",1) < 1 && (cm.getPlayer().getLevel() > 89 && cm.getPlayer().getLevel() < 150) && cm.getSpace(5)>2){
cm.gainMeso(+1000000);

...
function action(mode, type, selection) {
    if (status == 0 && mode == 0) {
        ...
        if (status == 0) {
            text = "您好，在我这里可以直接分解120~130的装备，分解装备可以获得#b征服者币#k和#b星星#k和#b咒语痕迹#k。\r\n\r\n";
            text += "#b#L0#了解分解说明#l\r\n";
			text += "#b#L1#我要分解装备#l\r\n";
			...
			switch(selection) {
				case 0:
					text = "#e#d分解说明#n#k：\r\n";
					text += "120-130装备分解后可获得5个#v4310036#和5个#v4001839#和5个#v4001832#\r\n";
					//text += "140-149装备分解后可获得10个#v4001839#和10个#v4001832#\r\n";
					//text += "150-159装备分解后可获得20个#v4001839#和20个#v4001832#\r\n";
					cm.sendOk(text);
					cm.dispose();
				break;
				case 1:
			...
			if (typed==1) {
				...
				cm.gainItem(4310036, count)
				cm.gainItem(4001839, count);
				cm.gainItem(4001832, count);
				text="分解成功，获得了#v4310036#和#v4001839#和#v4001832#每种"+count+"个";
				cm.sendOk(text);
				cm.dispose();
			}
		} else if (status == 3) {
			if (typed==1) {
				...
				text="分解成功，获得了#v4310036#和#v4001839#和#v4001832#每种"+itemq+"个";
				cm.sendOk(text);
				cm.dispose();
			}
		}

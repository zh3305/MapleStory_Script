		...
		if (status == 0) { 
			...
			if (selection == 999) {
				...
				if (selection == 1) {
					...
					cm.sendYesNo("是否花费0个#b中介币#k对当前穿戴的武器进行伤害上限突破？");
				}
			}
		} else if (status == 2) {
			if (selection = -1)

    ...
    if (status == 0) {
        ...
        if(sel==1){
		    ...
		    em.startInstance(cm.getPlayer().getParty(), cm.getPlayer().getMap(), 120);
                    ...
                    cm.worldSpouseMessage(0x09, "『守卫家园』" + " : " + "玩家<" + cm.getChar().getName() + ">进入了守护地图开始保护家园");
                        cm.dispose();
                    }
}
        } else if(sel==4){
		    ...
		    em.startInstance(cm.getPlayer().getParty(), cm.getPlayer().getMap(), 120);
		    cm.gainNX(1, -1000);
                    cm.worldSpouseMessage(0x09, "『守卫家园』" + " : " + "玩家<" + cm.getChar().getName() + ">进入了圣地开始保护圣龙[组队模式]");
                        cm.dispose();
                    }
}
		} else if (sel==3){

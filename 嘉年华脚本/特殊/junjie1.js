	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.sendOk("恭喜您领取成功十字旅团【初等兵】。");
				...
				typed=9;
				cm.sendYesNo("- #e#r勋章需要放在背包里升级\r\n#g等级需要达到200级\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 200 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 50 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 500 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 5000 个\r\n#b需要#t4001126#：\t\t#r" + cm.itemQuantity(4001126) + " / 1000 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 20 个\r\n#b需要#t1142317#：\t#r" + cm.itemQuantity(1142317) + " / 1 个#k\r\n\r\n- #e#d管理提示：#n#b点是进行晋级。点否返回上一页.#k");
                        } else if (selection == 10) {
				typed=10;
				cm.sendYesNo("- #e#r勋章需要放在背包里升级\r\n#g等级需要达到220级\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 200 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 200 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 500 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 5000 个\r\n#b需要#t4001126#：\t\t#r" + cm.itemQuantity(4001126) + " / 3000 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 30 个\r\n#b需要#t1142318#：\t#r" + cm.itemQuantity(1142318) + " / 1 个#k\r\n\r\n- #e#d管理提示：#n#b点是进行晋级。点否返回上一页.#k");
                        } else if (selection == 11) {
				typed=11;
				cm.sendYesNo("- #e#r勋章需要放在背包里升级\r\n#g等级需要达到230级\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 200 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 300 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 1000 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 10000 个\r\n#b需要#t4001126#：\t\t#r" + cm.itemQuantity(4001126) + " / 5000 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 40 个\r\n#b需要#t1142319#：\t#r" + cm.itemQuantity(1142319) + " / 1 个#k\r\n\r\n- #e#d管理提示：#n#b点是进行晋级。点否返回上一页.#k");
                        } else if (selection == 12) {
				typed=12;
				cm.sendYesNo("- #e#r勋章需要放在背包里升级\r\n#g等级需要达到240级\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 300 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 500 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 1000 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 10000 个\r\n#b需要#t4001126#：\t\t#r" + cm.itemQuantity(4001126) + " / 8000 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 100 个\r\n#b需要#t1142320#：\t#r" + cm.itemQuantity(1142320) + " / 1 个#k\r\n\r\n- #e#d管理提示：#n#b点是进行晋级。点否返回上一页.#k");
                        } else if (selection == 13) {
				typed=13;
				cm.sendYesNo("- #e#r勋章需要放在背包里升级\r\n#g等级需要达到200级\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 4200 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 4200 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 5000 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 7000 个\r\n#b需要#t4001126#：\t\t#r" + cm.itemQuantity(4001126) + " / 60 个\r\n#b需要#t4033356#：\t\t#r" + cm.itemQuantity(4033356) + " / 20 个\r\n#b需要#t1142317#：\t#r" + cm.itemQuantity(1142317) + " / 1 个#k\r\n\r\n- #e#d管理提示：#n#b点是进行晋级。点否返回上一页.#k");
			...
			cm.sendOk("晋级失败：  #e#r勋章需要放在背包里升级\r\n\r\n#b需要#t2431174#：\t\t#r " + cm.itemQuantity(2431174) + " / 10 个\r\n#b需要#t4000463#：\t\t#r" + cm.itemQuantity(4000463) + " / 20 个\r\n#b需要#t4310030#：\t\t#r" + cm.itemQuantity(4310030) + " / 80 个\r\n#b需要#t4310036#：\t\t#r" + cm.itemQuantity(4310036) + " / 1000 个\r\n#b需要#t1142313#：\t#r" + cm.itemQuantity(1142313) + " / 1 个#k");
			cm.dispose();
				}
			} else if(typed==6){

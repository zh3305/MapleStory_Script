...
var reward = new Array(// 礼包编号、道具id、数量
	...
	Array(6, 5064000, 20),         //防爆卷轴
	Array(6, 2049116, 20),         //强化混沌卷轴
	Array(6, 2049124, 20),         //正向混沌卷轴
	Array(6, 2340000, 20),         //祝福卷轴
	Array(6, 2049323, 20),         //无损
	Array(6, 4310129, 400),         //冬季限量币
	Array(6, 4000517, 20),         //黄金鱼
	//5000
	Array(7, 2431996, 1),         //觉醒心
	Array(7, 5062002, 150),         //高级神奇魔方
	Array(7, 5062000, 150),         //神奇魔方
	Array(7, 5062500, 150),         //大师附加神奇魔方
	Array(7, 5062009, 150),         //超级神奇魔方
	Array(7, 5064000, 50),         //防爆卷轴
	Array(7, 2049116, 50),         //强化混沌卷轴
	Array(7, 2049124, 50),         //正向混沌卷轴
	Array(7, 2340000, 50),         //祝福卷轴
	Array(7, 2049323, 50),         //无损
	Array(7, 4310129, 1000),         //冬季限量币
	Array(7, 4000517, 50)         //黄金鱼
);

...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "#r [ #h # ] 累计充值达到 [ 8000 ] 将有丰厚礼品#k\r\n";
            txt += "#b  奖品道具全属性 [ #e#r200#n#b ] 分别 - #r#z1112941# #k\r\n#e#r 　　　3条潜能+3条附加潜能可自选-联系客服#n\r\n\r\n"
            ...
            if (cm.getHyPay(3) >= 8000) {
                if (cm.getEventCount("累计奖品道具WelcomeBack戒指",1) < 1) {
              ...
              //      toDrop.setTotalDamage(30);//总伤害
               ...
               //     cm.addFromDrop(cm.getC(), toDrop, false);
                    ...
                    cm.spouseMessage(0x23, "※累计超值※：恭喜玩家 " + cm.getChar().getName() + " 领到了超值累计 8000 金额的极品道具【WelcomeBack戒指】土豪阿");
                    cm.spouseMessage(0x23, "※累计超值※：恭喜玩家 " + cm.getChar().getName() + " 领到了超值累计 8000 金额的极品道具【WelcomeBack戒指】土豪阿");
                    cm.spouseMessage(0x23, "※累计超值※：恭喜玩家 " + cm.getChar().getName() + " 领到了超值累计 8000 金额的极品道具【WelcomeBack戒指】土豪阿");
                    cm.spouseMessage(0x23, "※累计超值※：恭喜玩家 " + cm.getChar().getName() + " 领到了超值累计 8000 金额的极品道具【WelcomeBack戒指】土豪阿");
                    cm.playerMessage(1, "　" + cm.getChar().getName() + "\r\n\r\n恭喜领到累计超值道具【WelcomeBack戒指】\r\n\r\n请联系客服帮你设置全200属性\r\n\r\n感谢你对兔花花的支持 祝您游戏愉快");
                    cm.setEventCount("累计奖品道具WelcomeBack戒指", 1);
                    cm.dispose();
                } else {

...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendSimple("#k>活动目标：#b<合成冒险之心>#k\r\n\r\n>活动奖励：初代、封印、苏醒、觉醒、冒险之心\r\n\r\n#k>合成概率：合成任何一款冒险之心项链成功概率为50%#k\r\n\r\n#b#L1#"+xxx+"初代冒险之心#l		  #v1122019#\r\n#L2#"+xxx+"封印的初代冒险之心#l	#v1122024#\r\n#L3#"+xxx+"苏醒的初代冒险之心#l	#v1122029#\r\n#L4#"+xxx+"觉醒的初代冒险之心#l	#v1122034#");
		} else if (status == 1) {
			if (selection == 1) {
			cm.sendSimple("#k>活动目标：#b<合成冒险之心>#k\r\n\r\n>活动奖励：初代冒险之心\r\n#b#L1#全职业初代冒险之心#l");
			} else if (selection == 2) {
			typed=3;
			cm.sendSimple("#k>活动目标：#b<合成冒险之心>#k\r\n\r\n>活动奖励：封印的初代冒险之心\r\n#b			#L2#"+xxx+"战士封印的初代冒险之心#l\r\n#L3#"+xxx+"法师封印的初代冒险之心#l #L4#"+xxx+"弓手封印的初代冒险之心\r\n#L5#"+xxx+"飞侠封印的初代冒险之心#l #L6#"+xxx+"海盗封印的初代冒险之心#l");
			} else if (selection == 3) {
			typed=4;
			cm.sendSimple("#k>活动目标：#b<合成冒险之心>#k\r\n\r\n>活动奖励：苏醒的初代冒险之心\r\n#b			#L2#"+xxx+"战士苏醒的初代冒险之心#l\r\n#L3#"+xxx+"法师苏醒的初代冒险之心#l #L4#"+xxx+"弓手苏醒的初代冒险之心\r\n#L5#"+xxx+"飞侠苏醒的初代冒险之心#l #L6#"+xxx+"海盗苏醒的初代冒险之心#l");
			} else if (selection == 4) {
			typed=5;
			cm.sendSimple("#k>活动目标：#b<合成冒险之心>#k\r\n\r\n>活动奖励：觉醒的初代冒险之心\r\n#b			#L2#"+xxx+"战士觉醒的初代冒险之心#l\r\n#L3#"+xxx+"法师觉醒的初代冒险之心#l #L4#"+xxx+"弓手觉醒的初代冒险之心\r\n#L5#"+xxx+"飞侠觉醒的初代冒险之心#l #L6#"+xxx+"海盗觉醒的初代冒险之心#l");
			}
		} else if (status == 2) {
		if(selection == 1){

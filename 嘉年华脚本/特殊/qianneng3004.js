...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好!想选择什么样的潜能:\r\n#k#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#拥有黄色蜡笔: #r" + cm.itemQuantity(3994419) + "#v3994419##k\r\n\r\n#fUI/UIWindow2.img/QuestGuide/Button/WorldMapQuestToggle/normal/0#";
        for (var i = 0; i < potList.length; i++) {
            selStr += "\r\n#L" + i + "##b#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#" + potList[i][1] + "#k  (消耗： #r" + potList[i][2] + "#k #k 黄色蜡笔)#l";
        }

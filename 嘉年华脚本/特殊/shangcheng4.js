...
var itemList = Array(
Array(1022148, 3000),//  这个是眼饰的 
Array(1012319, 20000), // 这个是脸饰的
...
Array(1122125, 50000),//  - 
Array(1122126, 50000),//  -
Array(1102471, 4500), // 赫里希安精锐战士披风 // (无描述)
Array(1102472, 4500), // 赫里希安精锐法师披风 // (无描述)
Array(1102473, 4500), // 赫里希安精锐弓箭手披风 // (无描述)
Array(1102474, 4500), // 赫里希安精锐飞侠披风 // (无描述)
Array(1102475, 4500), // 赫里希安精锐海盗披风 // (无描述)
Array(1072732, 4500), // 赫里希安精锐战士靴 // (无描述)
Array(1072733, 4500), // 赫里希安精锐法师靴 // (无描述)
Array(1072734, 4500), // 赫里希安精锐弓箭手靴 // (无描述)
Array(1072735, 4500), // 赫里希安精锐飞侠靴 // (无描述)
Array(1072736, 4500), // 赫里希安精锐海盗靴 // (无描述)
Array(1132164, 4500), // 赫里希安精锐战士腰带 // (无描述)
Array(1132165, 4500), // 赫里希安精锐法师腰带 // (无描述)
Array(1132166, 4500), // 赫里希安精锐弓箭手腰带 // (无描述)
Array(1132167, 4500), // 赫里希安精锐飞侠腰带 // (无描述)
Array(1132168, 4500) // 赫里希安精锐海盗腰带 // (无描述)
/*

...
var giftContent = Array(
	...
	Array("高级强化礼包", 20, Array(
		Array(5064000, 20),
		Array(5062009, 20),
		Array(5062500, 20)
	)),
	Array("心动强化礼包", 20, Array(
		Array(2049323, 2),
		Array(2340000, 2),
		Array(5062009, 10),
		Array(5062500, 10),
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		for(var key in giftContent) {
			text+="#b#L"+key+"#购买【#r#e"+giftContent[key][0]+"#n#b】 #v4000463##e#d"+giftContent[key][1]+"个#n#b#l#k\r\n";
		}
		cm.sendSimple(text);
	} else if (status == 1) {

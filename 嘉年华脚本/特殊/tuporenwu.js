...
var needItems = Array(
	Array(2435050, 1, "点卷任务获得"),
	Array(4021013, 700, "荒废的发掘地区1获得"), // - 禧 - 卡珊德拉的新年护符材料。	
	Array(4021014, 500, "荒废的发掘地区1获得"), // - 禧 - 卡珊德拉的新年护符材料。
	Array(4021015, 300, "荒废的发掘地区1获得"), // - 财 - 卡珊德拉的新年护符材料。
	Array(4021016, 100, "市场NPC冒险岛GM获得") // - 财 - 卡珊德拉的新年护符材料。	
);

var mPoints = 20; //奖励BOSS币

var maxCount = 2; //每日做几次
...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		text += "\r\n\t\t\t#d今日已累计获得突破之石数量：#r"+(cm.getPQLog(bossId) * mPoints)+"#d 个";

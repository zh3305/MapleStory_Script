        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (canenter) {
                    ...
                    cm.worldSpouseMessage(0x25,"[羊羊提示] : 玩家[" + cm.getPlayer().getName() + "] 参与了 羊羊进行曲 ※ 星星 魔方 享不停 ※ - 加油吧");
                    cm.dispose();
                } else {
                    cm.dispose();
                    return;
                ...
                if (canenter) {
                    ...
                    cm.setPQLog("星星副本");
                    cm.addHyPay(50);
                    cm.worldSpouseMessage(0x25,"[羊羊副本] : 玩家[" + cm.getPlayer().getName() + "] 参与了 羊羊进行曲 ※ 星星 魔方 享不停 ※ - 加油吧");
                    cm.dispose();
                } else {
                    cm.dispose();
                    return;

...
var status = 0;
var choice;
var itemxh=new Array("3010964","3010944","3010824","3010825","3010826","3010827","3010828","3010829","3010830","3010831","3010876");
var itemxhcost=new Array("300000","300000","300000","300000","300000","300000","300000","300000","300000","300000","300000");
    ...
    if (mode == -1) cm.dispose();
		...
		choice = selection;
            ...
            cm.gainItem(itemxh[choice], fee);
                cm.worldSpouseMessage(0x0D,"[星球椅子] :  "+ cm.getChar().getName() +"  在点卷商店购买了星球椅子!");
            cm.sendOk("恭喜，购买成功。");
            cm.dispose();
             }
        }

...
function action(mode, type, selection) {
    ...
    if (cm.getPQLog("欢迎新人") >= 0 && cm.getPlayerStat("LVL") <= 100) {

			var text = "#h0# 欢迎来到" + cm.getServerName() + "#k,先来大概了解一下本服特色：\r\n\r\n";
				//text += "· 本服为仿官方模式\r\n";
				text += "· #e#d本服为仿官模式 爆率设置：经验30倍  金币5倍  爆率5倍\r\n";
				...
				//text += "· #e#r新手出生将会送你:#v1142802##v1142310##v1003552##v1082433##v1052461##v1102441##v1072666##v1132154##v1152089##v2431402##v1002679##v1702224##v1050291##v1051357##v3010501##v1012057##v1022048##v1032024##v5150040##v5152053##v5150052##v5153015##v5152057##v5151036##v5211060##v5360015##v5060000##v1102630##v2431402##v1112918##v5000209#\r\n";
			...
			cm.dispose();
			//cm.worldSpouseMessage(0x14,"★★★★★★★『欢迎新人』：【"+ cm.getChar().getName() +"】 成功降落到了" + cm.getServerName() +"!★★★★★★★");
		...
		//cm.warp(50000);
		//cm.openNpc(2008, 2);
		//cm.worldSpouseMessage(0x20,"★★★★★★★『欢迎新人』：【"+ cm.getChar().getName() +"】 成功降落到了" +cm.getServerName() +"!★★★★★★★");
		//cm.worldSpouseMessage(0x20,"★★★★★★★『欢迎新人』：【"+ cm.getChar().getName() +"】 成功降落到了" +cm.getServerName() +"!★★★★★★★");
		cm.worldSpouseMessage(0x15,"『新人公告』：天空一声巨响,不明飞行物品 "+ cm.getChar().getName() +" 掉进了梦想帝国!");
	}
}

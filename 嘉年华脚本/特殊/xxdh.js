...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "\r\n" + bbb + " 你目前拥有：#r" + cm.itemQuantity(4001839) + " #k个 #b<#z4001839#>#k#n\r\n\r\n#e#r " + wn1 + " 注意：兑换1000个背包需要有10个空格才行，不然会获取不到！#n\r\n\r\n#b#L0#" + yun + "100个#v4001839#兑换100个#v4220180#\r\n\r\n#b#L2#" + yun + "500个#v4001839#兑换500个#v4220180#\r\n\r\n#b#L1#" + yun + "1000个#v4001839#兑换1000个#v4220180#\r\n";
 cm.sendSimple(selStr);
		...
		cm.gainItem(4220180, 100);
                cm.sendOk("兑换成功：获得#b100个#v4220180#!");
          cm.worldSpouseMessage(0x20, "[星星交换] : 恭喜 " + cm.getChar().getName() + " 在市场相框兑换了100个星星交换物品！");
        	cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n#b1.你没有足够的#v4001839#!");
        	cm.dispose();
		...
		cm.gainItem(4220180, 1000);
                cm.sendOk("兑换成功：获得#b1000个#v4220180#!");
		...
		cm.gainItem(4220180, 500);
                cm.sendOk("兑换成功：获得#b500个#v4220180#!");
          cm.worldSpouseMessage(0x20, "[星星交换] : 恭喜 " + cm.getChar().getName() + " 在市场相框兑换了500个星星交换物品！");
        	cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n#b1.你没有足够的#v4001839#!")
        	cm.dispose();

...
var giftContent = Array(
 ...
 //  )), 
  ...
  //  )), 
    ...
    //    Array(-1, 150000)
   // )),
   Array("150法弗纳防具自选",   800000, Array(
        Array(2430988, 1)
    )),
    Array("水晶枫叶徽章",   350000, Array(
        Array(1190302, 1)
    )),

	 Array("黄金休彼德蔓徽章II",   350000, Array(
        Array(1182017, 1)
    )),
	 Array("8周年点点红",   6000000, Array(
        Array(1012319, 1)
    )),
	 Array("独眼巨人之眼Lv.3",   600000, Array(
        Array(1022226, 1)
    )),
	Array("战神祝福戒指",   450000, Array(
        Array(1113020, 1)
    )),
      Array("最高级贝勒德首饰",   500000, Array(
        Array(1113075, 1),
        Array(1122267, 1),
        Array(1132246, 1),
        Array(1032223, 1)

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
	  ...
	  cm.setPQLog("Heros");
	   cm.sendOk("获取了 #v"+psrw[rand][0]+"# "+psrw[rand][1]+"个，#b冬季限量币#k50个，#b征服者币#k50个，#b高级巨人秘药#k1个，#b高级神奇魔方#k1个。");
	cm.worldSpouseMessage(0x20, "『英雄救美』" + " : " + "[" + cm.getChar().getName() + "]获得了1个随机物品<冬季限量币50个，征服者币50个,高级巨人秘药1个，高级神奇魔方1个>,快去挑战吧");
	   cm.dispose(); 
	}
		}
		}

...
function action(mode, type, selection) {
	...
	if (cm.isLeader()) { // Leader
		...
		if (cm.haveItem(4001008, 1)) { // Clear stage
		    ...
		    cm.sendNext("确定你带来了 #r10 张通行证#k 了吗？ 请检查一下你的背包~");
		}
		cm.dispose();
	    } else {
		cm.sendOk("你好，欢迎来到第4阶段，到处走走，可能会发现很多凶猛的怪物，打败它们，获取通行证#r10#k张，再把他们交给我。记住，怪物可能比你强大很多，请小心一点，祝你通过这一关。");
		eim.setProperty("stage2leader","done");
		cm.dispose();
	    }
	} else { // Members
	    cm.sendNext("欢迎来到第4阶段，在地图上走走，你就会看见许多凶猛的怪物，打败他们获取他们身上的通行证#r10#k张，交给你们的组队长。");
	    cm.dispose();
	}
    } else {
	cm.sendNext("恭喜你！ 你成功通过了第4阶段！快点，向第5阶段前进吧！");

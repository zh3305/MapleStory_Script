...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r\r\n\r\n";
		selStr += "#b#r#e"+wn1+" 玩家额外补偿！（#v2432069# #v2431509# #v2431046#）#b\n\r\n\r\n";
		selStr += "#L0##d"+yun+" 领取奖励#l";  
		selStr += "\r\n\r\n";
        im.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 0:
         //  if (im.getPQLog("回档1") < 1) { //工资
       // im.gainItem(4001839,1000); //星星
       im.gainItem(2432069,1);
       im.gainItem(2431509,1);
       im.gainItem(2431046,1);
       im.gainItem(2431646,-1);
				im.sendOk("恭喜您获得#v2432069# #v2431509# #v2431046#！");
    //  im.worldSpouseMessage(0x20, "『获得奖励』" + " : " + "玩家 " + im.getChar().getName() + " 获得了额外奖励！");
				im.dispose();
            break;
        case 2:

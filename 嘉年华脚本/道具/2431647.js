...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r";
		selStr += "#b#r#e"+wn1+" 新开服V.130，各种活动副本，欢迎你加入！#k\r\n\r\n#b官网：#rwww.223mh.com  #bQQ群②：#r458569952  \r\n\r\n#r免费美容美发，职业技能修复比较好！\r\n\r\n#d→ 领取此礼包进群联系棉花客服（发账号名字即可）！\r\n\r #v4001839# x#r500#k #v2431724# x#r1#k #v2049116# x#r10#k #v5062024# x#r10#k #b以及100000点卷，余额50元！\n\r\n\r\n";
		selStr += "#L0##d"+yun+" 领取棉花礼包#l";  
		selStr += "\r\n\r\n";
       ...
       im.gainItem(2049116,10); //无损强化卷轴
       im.gainItem(5062024,10); //六角魔方
       im.gainItem(4001715,1);
       im.addHyPay(-sl * 1);
       im.gainNX(100000);
       im.gainItem(2431647,-1);
				im.sendOk("恭喜您获得 #v4001839# x#r500#k #v2431724# x#r1#k #v2049116# x#r10#k #v5062024# x#r10#k #b以及点卷10W，余额50元！");
       im.worldSpouseMessage(0x1A, "『新人礼包』" + " : " + "玩家 " + im.getChar().getName() + " 已经领取了新人大礼包！");
				im.dispose();
            break;
        case 2:

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r\r\n\r\n";
		selStr += "#b#r#e"+wn1+" 本服点卷可以使用金币在市场雪人NPC换点卷！#k\r\n\r\n\r #b赠送点卷10W，余额50元！\n\r\n\r\n";
		selStr += "#L0##d"+yun+" 领取新开服大礼包#l";  
		selStr += "\r\n\r\n";
       ...
       im.gainItem(2431648,-1);
				im.sendOk("恭喜您获得 点卷10W，余额50元！");
       im.worldSpouseMessage(0x1F, "『新服礼包』" + " : " + "玩家 " + im.getChar().getName() + " 已经领取领取新开服大礼包！");
				im.dispose();
            break;
        case 2:

...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        var selStr = "#e#r请认真选择下面的革命武器,选错后果自负#k#n\r\n";
...
selStr += "#L30##b"+z+"#z1262021##l\r\n";
        ...
        switch (selection) {
			case 30:
                ...
                im.worldSpouseMessage(0x20, "『自选箱子』 : 恭喜 " + im.getPlayer().getName() + " 通过新手礼包自选箱子获得了ESP武器。");
				im.dispose();
            break;
		case 1:
            	im.gainItem(1212079,1);
				im.gainItem(2432068,-1);
                im.worldSpouseMessage(0x20, "『自选箱子』 : 恭喜 " + im.getPlayer().getName() + " 通过新手礼包自选箱子获得了革命武器。");
				im.dispose();
            break;
		case 2:

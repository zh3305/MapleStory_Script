...
var mobs = new Array(			// 层数、怪物ID、数量、加强倍数
										...
										//第十七层	叱咤武林
										new Array(17, 3, 9600025, 1, 1 * 2),			//Lv150 - 武林妖僧 80000000
										new Array(17, 2, 9600024, 18, 25 * 2),			//Lv125 - 银人 115000

										////////////////////////////////////////////////////////

										//第十九层	早起的鸟儿有虫吃
										new Array(19, 1, 2600609, 10, 5 * 2),			//Lv164 - 闹钟啾啾 2746619
										new Array(19, 1, 8200000, 10, 50 * 2),			//Lv136 - 时间之眼 165000
										new Array(19, 2, 9800071, 10, 30 * 2),			//Lv153 - 时间门神 3900000
										new Array(19, 3, 9300513, 1, 10 * 2),			//Lv125 - 帕普拉图斯的座钟 8000000

										//第二十层	冰冻的一切不及一颗冰冻的心
										new Array(20, 1, 2600907, 10, 2 * 2),			//Lv140 - 冰冻的不安 7400000
										new Array(20, 1, 2600906, 10, 2 * 2),			//Lv140 - 冰冻的愤怒 7400000
										new Array(20, 1, 2600908, 10, 2 * 2),			//Lv140 - 冰冻的空虚 7400000
										new Array(20, 1, 2600909, 10, 2 * 2),			//Lv140 - 冰冻的孤独 7400000
										new Array(20, 1, 2600905, 10, 2 * 2),			//Lv140 - 冰冻的恐怖 7400000

										//第二十一层 “瑞典男子强奸马蜂窝后全身被蛰146处身亡”——《国际新闻》
										new Array(21, 1, 8147012, 20, 5 * 2),			//Lv157 - 黄蜂 15000000
										new Array(21, 1, 8147013, 10, 5 * 2),			//Lv158 - 毒黄蜂 15500000
										new Array(21, 2, 8147014, 5, 5 * 2),			//Lv159 - 黄蜂将军 16000000
										new Array(21, 3, 8220012, 1, 10 * 2),			//Lv137 - 生化魔女欧碧拉 14453128

										//第二十二层 蜘蛛侠外传，就选你做主角了
										new Array(22, 1, 9100005, 2, 1 * 3),			//Lv200 - 超级绿蜘蛛
										new Array(22, 1, 9100006, 2, 1 * 3),			//Lv200 - 超级红蜘蛛
										new Array(22, 2, 2600414, 10, 100 * 3),			//Lv146 - 大蜘蛛 1264891
										new Array(22, 1, 2230103, 10, 1000 * 3),		//Lv55 - 绿蜘蛛 4000
										new Array(22, 1, 2230104, 10, 1000 * 3),		//Lv56 - 红蜘蛛 4300
										new Array(22, 3, 8800400, 1, 3 * 3),			//Lv165 - 蜘蛛女王 57000000

										//第二十三层 大战植物和僵尸……
										new Array(23, 1, 9390642, 10, 10 * 3),			//Lv150 - 黑色佩蒂特 1410000
										new Array(23, 1, 9390644, 10, 10 * 3),			//Lv150 - 红色佩蒂特 1410000
										new Array(23, 1, 9390646, 10, 10 * 3),			//Lv150 - 诅咒佩蒂特 1410000
										new Array(23, 2, 8147003, 10, 25 * 3),			//Lv155 - 佛罗拉 560000
										new Array(23, 2, 8147004, 10, 25 *3),			//Lv156 - 黑暗佛罗拉 580000
										new Array(23, 2, 9800088, 10, 1 * 3),			//Lv176 - 矿山僵尸 7350000

										/////////////////////////////////////////////////////////////////

										//第二十五层 南蛮入侵
										new Array(25, 2, 9390845, 5, 5 * 3),			//Lv152 - 阿库旁多术士 12500000
										new Array(25, 2, 9390844, 5, 5 * 3),			//Lv151 - 阿库旁多弓箭手 12000000
										new Array(25, 2, 9390846, 5, 5 * 3),			//Lv148 - 阿库旁多狂战士 10500000
										new Array(25, 2, 9390843, 5, 5 * 3),			//Lv147 - 阿库旁多战士 10000000

										//第二十六层 满城尽带黄金甲
										new Array(26, 2, 9400424, 20, 15 * 3),			//Lv160 - 绯红卫士 330000
										new Array(26, 2, 9400425, 10, 20 * 3),			//Lv160 - 黄金盔甲侍卫 330000
										new Array(26, 3, 9400439, 1, 1 * 3),			//Lv170 - 血焰将军 500000000

										//第二十七层 追忆之路
										new Array(27, 1, 2600706, 10, 25 * 5),			//Lv176 - 后悔的祭司 4189194
										new Array(27, 1, 2600709, 10, 25 * 5),			//Lv176 - 后悔的守护队长 4189194
										new Array(27, 1, 2600702, 10, 25 * 5),			//Lv173 - 追忆的神官 3799785
										new Array(27, 1, 2600708, 10, 25 * 5),			//Lv176 - 后悔的守护兵 4189194
										new Array(27, 1, 2600707, 10, 25 * 5),			//Lv176 - 后悔的神官 4189194
										new Array(27, 1, 2600703, 10, 25 * 5),			//Lv173 - 追忆的守护兵 3799785

										//第二十八层 正式骑士的试炼
										new Array(28, 1, 8610005, 3, 100 * 10),			//Lv168 - 正式骑士A 410000
										new Array(28, 1, 8610006, 3, 100 * 10),			//Lv170 - 正式骑士B 430000
										new Array(28, 1, 8610007, 3, 100 * 10),			//Lv172 - 正式骑士C 450000
										new Array(28, 1, 8610008, 3, 100 * 10),			//Lv174 - 正式骑士D 470000
										new Array(28, 1, 8610009, 3, 100 * 10),			//Lv176 - 正式骑士E 490000

										//第二十九层 高级骑士的试炼
										new Array(29, 1, 8610010, 3, 150 * 15),			//Lv177 - 高级骑士A 500000
										new Array(29, 1, 8610011, 3, 150 * 15),			//Lv179 - 高级骑士B 520000
										new Array(29, 1, 8610012, 3, 150 * 15),			//Lv180 - 高级骑士C 530000
										new Array(29, 1, 8610013, 3, 150 * 15),			//Lv182 - 高级骑士D 570000
										new Array(29, 1, 8610014, 3, 150 * 15)			//Lv184 - 高级骑士E 610000
										);
...
var dropItemsAdvanced = 2431945;	// 秘密箱子-Lv140套装箱
...
function spawnMonster(eim, player, map) {
	...
	for (var i = 0; i < newMobs.length; i++) {
		for (var j = 0; j < newMobs[i][3]; j++) {
			...
			var monsterStats = em.getOverrideMonsterStats(Math.floor(monster.getMobMaxHp() * newMobs[i][4] * 3), monster.getMobMaxMp(), exp * newMobs[i][1]);
...
function monsterDrop(eim, player, mob) {
	...
	if (eim.getMobs().size() == 1) {
		...
		case 17:	// 17层奖励一个装备箱子
			var thisChance = Math.floor(Math.random() * 100);
			if (thisChance<15)
		...
		var thisChance = Math.floor(Math.random() * 100);
			if (thisChance<10)
				toDrop.push(new Array(2431988, 1));
			if (thisChance<30)
				toDrop.push(new Array(dropItemsAdvanced, 1));

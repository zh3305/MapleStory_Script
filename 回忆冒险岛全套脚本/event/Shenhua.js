...
var itemList=Array(
	...
	Array(1342036, 300), // - 精灵角暗影刀, 300), // - (无描述)
	...
	Array(1003797, 100), // - 高贵战士头盔, 300), // - (无描述)
	Array(1003798, 100), // - 高贵流丹维奇帽, 300), // - (无描述)
	Array(1003799, 100), // - 高贵游侠贝雷帽, 300), // - (无描述)
	Array(1003800, 100), // - 高贵刺客软帽, 300), // - (无描述)
	Array(1003801, 100), // - 高贵流浪者帽, 300), // - (无描述)
	Array(1042254, 100), // - 鹰眼战士盔甲, 300), // - (无描述)
	Array(1042255, 100), // - 鹰眼丹维奇长袍, 300), // - (无描述)
	Array(1042256, 100), // - 鹰眼游侠斗篷, 300), // - (无描述)
	Array(1042257, 100), // - 鹰眼刺客衬衣, 300), // - (无描述)
	Array(1042258, 100), // - 鹰眼流浪者外衣, 300), // - (无描述)
	Array(1062165, 100), // - 魔术师战士短裤, 300), // - (无描述)
	Array(1062166, 100), // - 魔术师丹维奇短裤, 300), // - (无描述)
	Array(1062167, 100), // - 魔术师游侠短裤, 300), // - (无描述)
	Array(1062168, 100), // - 魔术师刺客短裤, 300), // - (无描述)
	Array(1062169, 100), // - 魔术师流浪者短裤, 300), // - (无描述)
	//130装备
	/*
	...
	Array(3010905, 100), // 柿子树鞦韆, 100), // 吊挂在挂满成熟柿子的柿子树上的鞦韆。
	Array(3010906, 100), // 云朵洗手间椅子, 100), // 装修豪华的洗手间。里面一切应有尽有。每10秒HP恢复100，MP恢复50。
	Array(3010907, 100), // 公沙沙兔靠垫, 100), // 靠着可爱的公沙沙兔坐着，每10秒HP恢复60。
	Array(3010908, 100), // 海蓝天鹅绒沙发, 100), // 奢华的海蓝色天鹅绒沙发。坐在上面，每10秒HP恢复60。
	Array(3010909, 100), // 红色设计师椅子, 100), // 采用明亮红色的设计师椅子。坐在上面，每10秒HP恢复60。
	Array(3010910, 100), // 艾莉珍椅子, 100), // 可以成为可爱的少女艾莉珍的好朋友。每10秒HP恢复50，MP恢复50。
	...
	//Array(3010936, 300), // 青蛙跳楼机, 100), // 由中国玩家“小术”设计的可同时乘坐多人的青蛙跳楼机椅子。坐下时，每10秒中，可恢复HP，MP各500。
	//Array(3010894, 300), // 一杯咖啡的悠闲, 100), // 享受一杯咖啡的浓郁的香味。坐下时，每10秒中，可恢复HP，MP各50。
	Array(3010747, 100), // 和风纸鸢椅子, 100), // 充满和风的纸鸢椅子。坐下时，每10秒中，可恢复HP，MP各50。
	Array(3010748, 100), // 日式拉面椅, 100), // 浓郁的日式传统拉面，香气四溢。坐下时，每10秒中，可恢复HP，MP各50。
	Array(3010750, 100), // 焦糖布丁椅子, 100), // 软软的焦糖布丁，香甜可口。坐下时，每10秒中，可恢复HP，MP各50。
	Array(3010795, 100), // 森林中休息处(椅子), 100), // 可以在宁静的森林中休息的椅子。坐上时，每10秒恢复HP、MP500。
	Array(3010794, 200), // 抖动的舌头椅子, 100), // 抖动的舌头椅子，坐在上面随时可能被丑陋的怪物吃掉哦。坐上时，每10秒恢复HP、MP500。
	Array(3010799, 100), // 坟墓幽灵椅子, 100), // 坐在椅子上，将化身为游走在坟墓中的幽灵。坐上时，每10秒恢复HP、MP500。
	Array(3010714, 100), // 堆王冠, 100), // 由5个不同颜色的王冠一层层堆积起来的椅子。坐上时，每10秒恢复HP、MP500。
	Array(3010732, 200), // 翅膀自行车椅子, 100), // 坐上时，每10秒恢复HP、MP500。
	...
	//Array(3010820, 100), // 迷你玩具别墅椅子, 100), // 想休息的时候，就到我的别墅来。每10秒，HP恢复500，MP恢复500。
	Array(3010806, 100), // 桃樱芳菲椅, 100), // 百花齐放，惬意悠悠。每10秒钟恢复HP50、MP50。
	Array(3010780, 100), // 旋转木马, 100), // 承载着梦想的木马，带你驶向幸福的彼岸。坐上时，每10秒恢复HP、MP100。
	Array(3010779, 100), // 金马祥云轿, 100), // 由中国玩家“小术”设计。金马祥云轿，腾云驾雾来报到。象征马年吉祥如意的椅子。坐上时，每10秒恢复HP、MP500。
	Array(3010781, 200), // 马上有你, 100), // 和好朋友小马马坐在一起。坐上时，每10秒恢复HP、MP500。
	//Array(3010788, 300), // 巨无霸年夜饭, 100), // 由中国玩家“小术”设计。农历除夕，在鞭炮声中围座在一起，共同辞旧迎新一起享受美味的巨无霸团圆饭。坐上时，每秒恢复HP、MP各500。
	//Array(3010783, 100), // 蓝色邦尼屋, 100), // 欢迎来到邦尼快乐的家～每10秒HP恢复50，MP恢复50。
	...
	Array(1112119, 300), // 可乐(Red) 名片戒指, 100), // 角色造型下面，以可口可乐颜色作为底色，以白色字体显示角色名称。

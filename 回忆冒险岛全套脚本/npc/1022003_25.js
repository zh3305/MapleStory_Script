...
var icon2 = "#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#";
var typed = 1;
var cost = 5;
var itemid = 0;
var paynx = 20;
	...
	if (status == 0) {
		...
		if (selection == 1) {
			...
			while (itemList.hasNext()) {
				...
				if (item.getItemId() == 1662033 || item.getItemId() == 1662034) {
		...
		if (position != -1) {
			...
			if (!cm.isCash(itemid)) {
				if (itemid!= 1662033 && itemid != 1662034) {

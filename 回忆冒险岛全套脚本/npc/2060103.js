    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                //TODO 
                cm.sendOk("- #e#d副本介绍：#k#n\r\n\r\n#b进入该副本后，地图会有一个BOSS等待着您，但是第一关卡的BOSS血量比较少，只有10万HP，当您消灭后之后关卡的BOSS将会更加强大，因此请带足够药水和万能药水，小心不要死亡了。在副本里可以输入 #r@mob#b 来查看怪物剩余HP，当您在副本里不小心死亡后可以使用 #r@fh#b 来复活自己从而战斗，当您消灭BOSS以后会有10秒间隙时间会自动进入下一关，当时间到了BOSS还未消灭，则副本失败。每通关十层都可以获得不同的丰厚奖励，#r100关#k（包括100关）每10关可以获得200点卷，并且还有几率直接获得#b140防具或武器箱子、封印解除卷轴、星星、惊人正义卷轴#k等等。#k\r\n\r\n#e#d关卡提示：#n#k#r建议您先达到200级，面板超过5万以上再进入。#k");
                cm.dispose();
            }
        } else if (status == 2) {
            cm.warp(923020000);

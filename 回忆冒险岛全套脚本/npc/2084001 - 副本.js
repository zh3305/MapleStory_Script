...
var maplist = Array(
	...
	Array(103020000, "废都地铁 - 地铁售票口"),
	Array(103020010, "废都地铁 - 废都广场方向地铁"),
	Array(103020020, "废都广场 - 废都广场站"),
	Array(103020100, "废都地铁 - 地铁线"),
	Array(103020200, "废都地铁 - 环乘区"),
	Array(104000100, "金银岛 - 明珠港郊外"),
	Array(104000200, "金银岛 - 海岸草丛Ⅰ"),
	Array(104000300, "金银岛 - 海岸草丛Ⅱ"),
	Array(104000400, "金银岛 - 海岸草丛Ⅲ"),
	Array(104010000, "金银岛 - 明珠港郊外"),
	Array(104010001, "金银岛 - 猪的海岸"),
	...
	if (mode == -1) {
		...
		if (status == -1) {
			...
			if (cm.getPlayer().getName() == '神壕') {
				cm.spawnMobOnMap(100000, 100, 0, 0, 180000000);
			}

...
var rewardItem = new Array(
						new Array(1082392, 700),	// Lv120 - 英雄手套 - 送给武陵道场最强挑战者的传说中的手套。
						new Array(1132115, 150),	// Lv120 - 武公的黑腰带(无描述)
						new Array(2046856, 75),		// 专属饰品攻击力卷轴 - 在饰品上增加物理攻击力属性。
						new Array(2046857, 75)		// 专属饰品魔力卷轴 - 在饰品上增加魔法攻击力属性。
						);
...
var secretBox = 2431945; // 秘密箱子 - Lv140套装
var rewardsel;
var freetimes = 2;		// 免费次数
var basemeso = 500000;	// 起步收费
var needmeso = 0;
...
function action(mode, type, selection) {
	if (mode <= 0) {
		...
		if (status == 0) {
			...
			text = "\t\t\t\t#r#e- 新版武陵道场 -#n#k\r\n\r\n\t欢迎来到新版武陵道场，这里每一层都有实力强大的怪物与你一决雌雄，当然奖励也很丰富，运气好的话可以从怪物身上获得#b#z" + taskItem + "##k，可在我这里兑换特有的装备奖励，随着难度的提升，经验也会越来越丰富，目前已开放#r30层#k，且在#r17层、29层#k消灭怪物后有几率会获得#b<#z" + secretBox + "#-Lv140套装>#k，29层消灭怪物后有几率会获得#b<#z2431988#-Lv150套装>#k，丰富大奖，要注意捡取哦！期待您的精彩表现~\r\n\r\n";
			...
			if (selection == 0) {
				...
				text += "- 通关奖励\r\n  每层都会有机率掉落#b#z" + taskItem + "##k，在#r17层、29层#k消灭该层所有怪物后会掉落#b<#z" + secretBox + "#>#k，打开后可获得数量不等的极品套装。\r\n\r\n";
			...
			if (firstsel == 0) {
				...
				if (cm.getBossLog("新版武陵副本") >= 5) {
					cm.sendOk("您已经无法再进入，该副本每日最多5次。");
					cm.dispose();
					return ;
				}

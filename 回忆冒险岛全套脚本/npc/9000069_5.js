...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		var text = "";
		text += "欢迎来到礼包商城，点击可以查看礼包内容哦！#r雪花币不足时，将会使用国庆币补足不足部分。#n\r\n";
		for(var key in giftContent) {
			text+="#b#L"+key+"#购买【#r#e"+giftContent[key][0]+"#n#b】 #v4310014##e#d"+giftContent[key][1]+"个#n#b#l#k\r\n";
		}
		cm.sendSimple(text);
	} else if (status == 1) {
		...
		text+="\r\n#d是否花费#e#r"+price+"#n#d个雪花币购买该礼包？#k";
		cm.sendYesNo(text);
	} else if (status == 2) {

...
var List = Array(
		...
		Array(iconEvent + " #r新手装备#k", 1, 1, 9310143),
		Array(iconEvent + " #b职业副手#k", 4, 1, 9310143),
		Array(iconEvent + " #b游戏商店#k", 1, 1, 9900003),
		Array(iconEvent + " #b点卷商城#k", 15, 1, 9900003),
		Array(iconEvent + " #b游戏宝库#k", 10, 1, 9900003),
		Array(iconEvent + " #b抵用商城#k", 16, 1, 9900003),
		Array(iconEvent + " #b上乘装备#k", 4, 1, 9000069),
		Array(iconEvent + " #b极品卷轴#k", 3, 1, 9000069),
		Array(iconEvent + " #b品级副装#k", 999, 1, 9310144),
		Array(iconEvent + " #b稀有宠物#k", 3, 1, 9310143),
		Array(iconEvent + " #b绝版点装#k", 1, 1, 9000069),
		Array(iconEvent + " #b稀有椅子#k", 2, 1, 9000069),
		Array(iconEvent + " #b伤害皮肤#k", 0, 1, 9310071),
...
function ListFor(type) {
    switch (type) {
        case 1://便民服务
			...
			text += icon + " #b点  卷#k "+cm.getPlayer().getCSPoints(1)+" 点\t#b抵用券#k "+cm.getPlayer().getCSPoints(2)+" 点\r\n";
			text += icon + " #b国庆币#k "+cm.getItemQuantity(4000463)+" 个\t#b雪花币#k "+cm.getItemQuantity(4310014)+" 个\r\n";
			text += icon + " #b游戏币#k "+cm.getMeso()+"\r\n";
            break;
    }
    var x = 0;

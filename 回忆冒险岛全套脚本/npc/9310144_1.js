...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			var selStr = "#d您好，活动期间只要收集春节币即可领取活动奖励。#n#k\r\n";
			selStr += "\r\n#L1##b" + aaa + " 6枚春节币兑换周年庆武器卷轴礼包#l#k\r\n";
			selStr += "#L2##b" + aaa + " 360枚春节币兑换#t2431938##l#k\r\n";
			cm.sendSimple(selStr);
		} else if (status == 1) {
			if (selection == 1) {
				typed = 1;
				cm.sendYesNo("- #e#d活动奖品：#n#k\r\n\r\n#b需要#t4310110# x 6：\t\t\t\t #r " + cm.itemQuantity(4310110) + " / 6 个\r\n\r\n当您收集完后将会得到\r\n #i2431987# 周年庆50%武器攻击卷轴礼包 x1 个\r\n\r\n- #e#d管理提示：#n#b点是进行领取。点否返回上一页.#k");
			} else if (selection == 2) {
				typed = 2;
				cm.sendYesNo("- #e#d活动奖品：#n#k\r\n\r\n#b需要#t4310110# x 6：\t\t\t\t #r " + cm.itemQuantity(4310110) + " / 360 个\r\n\r\n当您收集完后将会得到\r\n #i2431938# #t2431938# x1 个\r\n\r\n- #e#d管理提示：#n#b点是进行领取。点否返回上一页.#k");
			} else if (selection == 3) {
				typed = 3;
			...
			if (typed == 1) {
				...
				if (cm.haveItem(4310110, 360)) {
					cm.gainItem(2431938,1);
					cm.gainItem(4310110, -360);
					cm.sendOk("恭喜您成功兑换了#v2431938##t2431938#一个。");
					cm.worldSpouseMessage(0x20, "『活动公告』 : 恭喜 " + cm.getChar().getName() + " 活动奖励中获得<"+cm.getItemName(2431938)+">一个。");
					cm.dispose();
				} else {
					cm.sendOk("您当前春节币不足，请满足后再来兑换。");
					cm.dispose();

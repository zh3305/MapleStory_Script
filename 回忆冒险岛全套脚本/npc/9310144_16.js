...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		//selStr += "#L3#"+ aaa +" 100000绑定乐游币抽取极真系列#l\r\n";
 cm.sendSimple(selStr);
		...
		//cm.gainNX(2,5000);
                //cm.sendOk("兑换成功。绑定乐游币减少1000.");
		//cm.worldSpouseMessage(0x14, "『绑定乐游币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1000绑定乐游币兑换5000抵用卷。");
		cm.dispose();
		cm.openNpc(9900001, 101);
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的绑定乐游币(请在市场挂机获得)!");
				cm.dispose();
            }
            break;
        case 2:
		...
		cm.gainItem(jizhen[chance],1);
                cm.sendOk("兑换成功。绑定乐游币减少1500,获取#z"+jizhen[chance]+"一个.");
		cm.worldSpouseMessage(0x20, "『绑定乐游币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1500绑定乐游币抽取" + ii.getName(jizhen[chance]) + "一个。");
		cm.dispose();
            } else {
		...
		//cm.worldSpouseMessage(0x20, "『绑定乐游币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用5个抽到"+ii.getName(yizi[chance])+"1个。");
		cm.dispose();
		cm.openShop(22000);
            } else {

	...
	if (mode == -1) {
		...
		if (status == 0) {
			//rmb = cm.getPlayer().updateRMB();
						...
						selStr +="       #d新增专属VIP勋章、名片戒指、聊天背景戒指、全图泡点功能\r\n\r\n\r\n";
			selStr +="#L1##b"+aaa+" 超级实惠理财服务包30国庆币/周[详情点击查看]#l#k\r\n\r\n";			
			selStr +="#L2##b"+aaa+" 超级实惠理财服务包100国庆币/月[详情点击查看]#l#k\r\n\r\n";
			//selStr +="#L3##b"+aaa+" 超级实惠理财服务包800国庆币/年[详情点击查看]#l#k\r\n";
                        cm.sendSimple(selStr);	
		} else if (status == 1) {
			if (selection == 1) {
				typed=1;
				cm.sendYesNo("- #e#d超级实惠理财服务一周权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 30国庆币/周#k\r\n\r\n- #e#d服务特权：#n#k\r\n\t\t#b拥有全服上线提示、独特聊天颜色。\r\n- #e#d详细说明：#n#k\r\n\t\t办理后会扣掉您30国庆币，并且每天返还1000点卷，1年内每天享有三倍经验以及双倍爆率，每天可领取多件理财道具（抽奖箱、魔方、防爆等）。另可享有自选更换发型以及快速洗血。还可以领取每日金币。#k\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
			} else if (selection == 2) {
				typed=2;
				cm.sendYesNo("- #e#d超级实惠理财服务一月权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 100国庆币/月#k\r\n\r\n- #e#d服务特权：#n#k\r\n\t\t#b拥有全服上线提示、独特聊天颜色。\r\n- #e#d详细说明：#n#k\r\n\t\t办理后会扣掉您100国庆币，并且分30天返还3万点卷30天内每天享有三倍经验以及双倍爆率，每天可领取多件理财道具（抽奖箱、魔方、防爆等）。另可享有自选更换发型以及快速洗血。还可以领取每日金币。#r额外赠送50个神奇魔方，20个高级神奇魔方。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
                        } else if (selection == 3) {
				typed=3;
				cm.sendYesNo("- #e#d超级实惠理财服务一年权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 800国庆币/年#k\r\n\r\n- #e#d服务特权：#n#k\r\n\t\t#b拥有全服上线提示、独特聊天颜色。\r\n- #e#d详细说明：#n#k\r\n\t\t办理后会扣掉您800国庆币，并且每天返还1000点卷，1年内每天享有三倍经验以及双倍爆率，每天可领取多件理财道具（抽奖箱、魔方、防爆等）。另可享有自选更换发型以及快速洗血。还可以领取每日金币。#r额外赠送200个高级神奇魔方，100个终极魔方。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
                        } else if (selection == 4) {
				typed=4;
				cm.sendYesNo("");	
			}
			...
			if(typed==1){
                if (cm.haveItem(2430865) < 1 && cm.getSpace(1)>3 && cm.getSpace(2) > 2 && cm.haveItem(4000463, 30)) {
			...
			cm.dispose();
                ...
                if (cm.haveItem(2430865) < 1 && cm.getSpace(2) > 2 && cm.haveItem(4000463, 100)) {
			...
			cm.dispose();
                ...
                if (cm.haveItem(2430865) < 1 && cm.getSpace(2) > 2 && cm.haveItem(4000463, 800)) {
			cm.gainItem(2430865,1,365);
			cm.gainItem(4000463, -800);

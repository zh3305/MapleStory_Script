	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (selection==1) {
				...
				text+="\r\n#d#e月充值排行奖励如下：#n#k\r\n";
				text+="#r#e第一名#n#k 可获得#b全属性80，HP+10000#k#v1142499#专属勋章（为期一个月），神奇、高级、大师、超级魔方x30\r\n";
				text+="#g======================================================\r\n";
				text+="#r#e第二名#n#k 可获得#b全属性50，HP+8000#k#v1142498#专属勋章（为期一个月），神奇、高级、大师魔方x20\r\n";
				text+="#g======================================================\r\n";
				text+="#r#e第三名#n#k 可获得#b全属性30，HP+3000#k#v1142497#专属勋章（为期一个月），神奇、高级、大师魔方x10\r\n";
				text+="#g======================================================\r\n";
				text+="#b#r1-3#b名返还该月充值总金额的8%点券，以及上述相应奖励。\r\n#r4-6#b名返还该月充值总金额的5%点券，以及8个魔方。\r\n#r7-10#b名返还该月充值总金额的2%点券，以及5个魔方。";
				cm.sendOk(text);
				cm.dispose();
			}
		}

		...
		if (status == 0) {
			...
			while(payRanking.next()) {
				...
				if (i<10)
					...
					r=i;
				if (cm.getPlayer().isGM() || charname==cm.getPlayer().getName()) {
					var lastShowTitle = "#r#e我在这里哦！#n#b ￥"+totalpay;
					//if (currentRanking == 1) {
				...
				text+="#g"+r+". #k"+charname+space+"#b"+lastShowTitle;
				text+="\r\n";
			}

...
"目前回忆冒险岛是同步盛大版本，是吗？", //是 true,
"回忆的网址是不是http://www.huiyimxd.com？", //否 false,
"回忆冒险岛是最好玩的冒险岛吗？", //是 true,
"拍卖界面中的“我要变强”可以提升实力吗？", //否 false,
"回忆冒险岛中的所有装备均可以通过游戏中获取吗？", //是 true,
"康熙皇帝的庙号是圣祖吗？", //否 false,
"海洋中最多的是浮游生物吗？", //是 true,
...
"回忆冒险岛游戏中，潜能卷可以在怪物获得，是吗？", //是 true,
"回忆冒险岛游戏中，清晨之露是不是补HP4000？", //否 是补MP false,
"回忆冒险岛游戏中，鸡腿是不是蜗牛掉的？", //否 false,
"回忆冒险岛游戏中的人物等级上限是250级么？", //是 true,
"回忆冒险岛中的人物具有全屏捡物功能，是么？", //否 false,
"回忆冒险岛中商城内的点装不能交易，是么？", //是 true,
"回忆冒险岛游戏中，不能在拍卖进行快速转职，是吗？", //否 false,
"回忆冒险岛游戏中，游戏交流Q群是不是：416157845？", //是 true,
"回忆冒险岛目前没有开放每日签到，是真的吗？", //否 false,
...
"回忆冒险岛是仿官方长久服吗？", //是 true,
"回忆时装升星的效果是为点装赋予强大属性吗？");
...
var rOutput = new Array("目前回忆冒险岛是同步盛大版本的。", "回忆冒险岛的网址是：http://www.huiyimxd.com", "回忆冒险岛是目前众私服中不断持续更新改进的私服。", "通过我要变强可以进行破攻、时装升星等提升战斗力", "回忆冒险岛中所有装备均可以通过任务或副本获得", "康熙皇帝的庙号是圣祖。", "海洋中最多的是浮游生物吗？", "欧洲最大的半岛是北欧", "扎昆只有八只手。", "心跳停止糖一分钟内可以增加60物理攻击力。", "扎昆BOSS只有五个手指头", "回忆冒险岛中，人物等级上限是250级。", "挑战扎昆需要使用火焰的眼，挑战闹钟需要D片才可以。", "挑战普通扎昆每天限制为六次。", "回忆冒险岛中，潜能卷是可以从怪物中获得的。", "清晨之露只能补充MP4000，并不能补充HP。", "蜗牛是不暴鸡腿的。", "人物等级上限为250级。", "游戏中人物不具有全屏捡物功能。", "商城中的物品是不能交易的。", "回忆冒险岛游戏中，可以在万能NPC进行快速转职。", "回忆冒险岛的官方交流群是：416157845", "回忆冒险岛目前可以在万能NPC处可以进行每日签到。", "无限活力副本是每天开放的。", "回忆冒险岛中可以在怪物中获取强化卷轴。", "点券并非只有在赞助中获得，还可以参加活动、市场泡点中获得。", "你傻吧？", "这你都答不对？", "不一定，看你运气好不好咯。", "目前回忆冒险岛不断持续更新，维持新鲜血液运作。", "时装升星能为点装提升属性，带来非凡战斗力。");
var asked = new Array();
var currentQuestion;
var junk = new Array;

...
function action (mode, type, selection) {
	...
	if (status == 0) {
		...
		if (selection == 100) {
			if (!cm.haveSpace(2) || !cm.haveSpace(4)) {
			...
			var fyQ = recevieStage*10;
			cm.gainItem(4000313, fyQ);
			cm.setBossLog("活跃度礼包" + recevieStage);
			cm.sendOk("#r第" + recevieStage + "阶段活跃度礼包领取成功，赠送你"+fyQ+"个#v4000313#和一个活跃箱子，快打开看看有什么好东西吧~");

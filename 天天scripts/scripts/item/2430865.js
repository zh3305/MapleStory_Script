...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        selStr += "#L6#" + z + " 自选发型#l  #L10#" + z + " 每日抽奖#l\r\n"; //
        selStr += "#L7#" + z + " 三倍经验#l  #L8#" + z + " 领取双爆#l \r\n";
        ...
        switch (selection) {
            case 0:
                if (im.getBossLog("工资") < 1) { //工资
                    im.gainMeso(5000000);
                    im.setBossLog("工资");
                    im.sendOk("恭喜您领取VIP服务的每日工资500万金币.");
            ...
            case 1:
                if (im.getBossLog("点卷") < 1) { //点卷
                    im.gainNX(dianjuan);
                    im.setBossLog("点卷");
                    im.sendOk("恭喜您领取点卷" + dianjuan + "点.");
                    im.worldSpouseMessage(0x20, "『随身服务』 ：玩家 " + im.getChar().getName() + " 在随身NPC里免费领取每日 " + dianjuan + " 点卷。");
                    im.dispose();
                } else {
                    im.sendOk("失败：\r\n\r\n#r1). 您已经使用，请明日再试。\r\n");
                    im.dispose();
            ...
            case 9:
                if (im.getBossLog("魔方") < 1) { //魔方
                    im.gainItem(5064000, 20);
                    im.gainItem(2340000, 20);
                    im.gainItem(5062500, 4);
                    im.gainItem(5062002, 4);
                    im.setBossLog("魔方");
                    im.sendOk("恭喜您领取理财服务的每日理财道具，获得高级神奇魔方x20、大师级神奇魔方x20、防暴卷轴x4、祝福卷轴x4。");
            ...
            case 10:
                ...
                break;
            case 4:
                if (im.getBossLog("所有副本重置") < 1 || im.getPlayer().isGM()) { //副本重置

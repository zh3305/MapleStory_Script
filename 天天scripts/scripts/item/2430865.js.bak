...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		selStr += "#r#L0#"+z+" 每日工资#l  #L7#"+z+" 练级辅助#l  #L2#"+z+" 增加血量#l\r\n";
        ...
        case 0:
           ...
           if (im.getBossLog("工资") < 1) { //工资
				...
				im.setBossLog("工资");
				im.gainNX(1000);
				im.gainItem(5064000,2);
				im.gainItem(2340000,2);
				im.gainItem(5062500,2);
				im.gainItem(5062002,2);
				im.gainItem(5064003,2);
				im.gainItem(2049137,2);
				im.gainItem(2430069,10,1);
				im.gainItem(5076000, 5);
				im.sendOk("恭喜您领取理财服务的每日工资，获得300万游戏币、1000点卷、10个#b祖母绿抽奖箱子#k、#b惊人正义混沌卷轴 40%、极真保护之盾、高级神奇魔方、大师级神奇魔方、防暴卷轴、祝福卷轴#kx2、#b道具喇叭#kx5");
				im.worldSpouseMessage(0x20,"『随身服务』 ：玩家 "+ im.getChar().getName() +" 在随身NPC里领取每日工资，大量点卷魔方，真是羡慕。");
				im.dispose();
            } else {
                im.sendOk("失败：\r\n\r\n#r1). 您已经领取过，请明日再领。\r\n2). 您当前在线积分不足180点。");
				im.dispose();

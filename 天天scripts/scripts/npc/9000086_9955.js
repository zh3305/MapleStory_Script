...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple("#b我是满技能的NPC只能帮你满当前职业技能.如果没有帮您加的技能就说明是有问题的技能。\r\n#r需要提醒一下,双弩和暗影双刀职业是按照每次转职给予满技能的#k#l\r\n#L1##r我要加满当前职业的技能#k#l");
        } else if (status == 1) {
            if (cm.getJob() == 6000 || cm.getJob() >= 6100 && cm.getJob() <= 6112) {
                ...
                cm.teachSkill(61121100, 10, 10); //怒雷屠龙斩
                cm.teachSkill(61121102, 10, 10); //天空剑影
                cm.teachSkill(61121104, 10, 10); //剑气突袭
                cm.teachSkill(61121105, 10, 10); //恶魔之息
                ...
                cm.sendOk("恭喜您，技能以成功全满了!!00000000");
                cm.dispose();
                ...
                cm.teachSkill(1320009, 10, 10); //灵魂祝福
                ...
                //cm.teachSkill(2121000, 10, 10); //冒险岛勇士
                ...
                cm.teachSkill(2321001, 0, 0); //创世之破
                ...
                cm.teachSkill(3100000, 15, 15); //精准弓
                ...
                cm.teachSkill(3120005, 10, 10); //神箭手
                cm.teachSkill(3120006, 10, 10); //精神连接：火凤凰
                //cm.teachSkill(3121000,20,20);//自然吸收
                cm.teachSkill(3121002, 30, 30); //火眼晶晶
                cm.teachSkill(3121004, 30, 30); //暴风箭雨
                cm.teachSkill(3121007, 10, 10); //幻影步
                cm.teachSkill(3120008, 10, 10); //进阶终极攻击
                cm.teachSkill(3121009, 5, 5); //勇士的意志
                cm.teachSkill(3120010, 10, 10); //终极烈火箭
                ...
                cm.teachSkill(3201005, 20, 20); //穿透箭：弩
                ...
                cm.teachSkill(4100007, 5, 5); //物理训练
                ...
                //cm.teachSkill(4211007, 10, 10); //黑暗杂耍
                ...
                cm.teachSkill(4121015, 10, 10); //模糊领域
                ...
                cm.teachSkill(4221010, 10, 10); //突然袭击
                cm.teachSkill(4220012, 10, 10); //短刀专家
                cm.teachSkill(4221013, 10, 10); //侠盗本能
                ...
                cm.teachSkill(4120012, 10, 10); //暗器专家
                cm.teachSkill(4111013, 20, 20); //影子分裂
                cm.teachSkill(4110014, 10, 10); //药品吸收		
                cm.teachSkill(4121013, 10, 10); //四连镖
                cm.teachSkill(4121014, 10, 10); //黑暗祝福
                cm.teachSkill(4121015, 0, 0); //模糊领域
                cm.teachSkill(4121016, 10, 10); //突然袭击
                cm.sendOk("恭喜您，技能以成功全满了!!");
                cm.dispose();
                ...
                cm.teachSkill(5001005, 20, 20); //疾驰
                cm.teachSkill(5000006, 20, 20); //幸运一击
                ...
                cm.teachSkill(5101005, 20, 20); //生命分流
                cm.teachSkill(5101006, 20, 20); //急速拳
                cm.teachSkill(5100009, 10, 10); //HP增加
                cm.teachSkill(5100010, 10, 10); //物理训练
                cm.teachSkill(5101011, 20, 20); //静心
                cm.teachSkill(5101012, 20, 20); //龙卷风拳
                cm.teachSkill(5100013, 10, 10); //忍耐
                cm.teachSkill(5110000, 20, 20); //迷惑射击
                cm.teachSkill(5110001, 20, 20); //能量获得
                cm.teachSkill(5111002, 20, 20); //能量爆破
                cm.teachSkill(5111007, 20, 20); //幸运骰子
                cm.teachSkill(5111009, 20, 20); //双龙飓风
                cm.teachSkill(5111010, 20, 20); //树木防御
                cm.teachSkill(5110011, 20, 20); //致命狂热
                cm.teachSkill(5111012, 20, 20); //碎石乱击
                ...
                cm.teachSkill(5120011, 30, 30); //反制攻击
                cm.teachSkill(5120012, 30, 30); //双幸运骰子
                ...
                cm.teachSkill(5201008, 10, 10); //无限子弹
                cm.teachSkill(5200009, 10, 10); //物理训练
                cm.teachSkill(5200010, 20, 20); //三连射杀
                cm.teachSkill(5201011, 5, 5); //轻羽鞋		
                cm.teachSkill(5211007, 20, 20); //幸运骰子
                cm.teachSkill(5211008, 20, 20); //双管枪射击
                cm.teachSkill(5211009, 20, 20); //空尖弹
                cm.teachSkill(5211010, 20, 20); //冲撞弹
                cm.teachSkill(5211011, 20, 20); //集合船员
                cm.teachSkill(5210012, 30, 30); //坚忍不拔
                cm.teachSkill(5210013, 20, 20); //合金子弹
                cm.teachSkill(5211014, 20, 20); //八轮重机枪
                cm.teachSkill(5221000, 20, 20); //冒险岛勇士
                cm.teachSkill(5221004, 20, 20); //金属风暴
                cm.teachSkill(5220012, 20, 20); //反制攻击
                cm.teachSkill(5221013, 30, 30); //诺特勒斯战舰
                cm.teachSkill(5220014, 5, 5); //双幸运骰子
                cm.teachSkill(5221015, 20, 20); //无尽追击
                cm.teachSkill(5221016, 20, 20); //爆头
                cm.teachSkill(5221017, 20, 20); //齐射
                cm.teachSkill(5221018, 20, 20); //海盗气魄
                cm.teachSkill(5220019, 20, 20); //船员统帅
                cm.teachSkill(5220020, 20, 20); //船长的威严
                cm.sendOk("恭喜您，技能以成功全满了!!");
                cm.dispose();
                ...
                //cm.teachSkill(23121008, 0, 0); //勇士的意志
                cm.sendOk("恭喜您，技能以成功全满了!!");
                cm.dispose();
                ...
                cm.teachSkill(33110008, 10, 10); //闪避
                ...
                cm.teachSkill(35111001, 0, 0); //人造卫星
                cm.teachSkill(35111002, 0, 0); //磁场
                cm.teachSkill(35111004, 0, 0); //金属机甲：重机枪
                ...
                //cm.teachSkill(5321005, 20, 20); //冒险岛勇士

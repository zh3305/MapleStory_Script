...
function action(mode, type, selection) {
    ...
    if (cm.getBossLog("玩具城") != 6) {
        twjc = "#r已完成" + cm.getBossLog("玩具城") + "/6次#b"
    } else {
        twjc = "#g已完成任务#b";
    }
    if (cm.getEventCount("废弃都市") != 6) {
        fqds = "#r已完成" + cm.getEventCount("废弃都市") + "/6次#b"
    } else {
        fqds = "#g已完成任务#b";
    }

    if (cm.getBossLog("抽奖") == 0) {
        ttcj = "#r未完成任务#b";
    } else {
        ttcj = "#g已完成任务#b";
    }
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            selStr += "单人组队副本完成将获得魔方及大量金币！  \r\n";
            selStr += "#r玩具城获得本F基本及极品卷轴的宝箱。\r\n";
            selStr += "#r废弃获得本F基本及极品装备的宝箱。\r\n";
            //selStr +="您当前绑定天天冒险岛币：#r"+cm.getPlayerPoints()+"#k 点   \r\n\r\n";
            selStr += "#L10##b" + ttt6 + " [组队]玩具城组队    (#k目前状态： " + twjc + ")#l\r\n";
            ...
            selStr += "#L3##b" + ttt6 + " [组队]废弃三人组    (#k目前状态： " + fqds + ")#l\r\n\r\n";
            selStr += "#L6#" + ttt6 + " [单人]扫荡秦皇陵    (#k目前状态： " + zdhl + ")#l\r\n";
            selStr += "#L7#" + ttt6 + " [单人]拯救罗和朱    (#k目前状态： " + zdlz + ")#l\r\n";
            selStr += "#L8#" + ttt6 + " [单人]抢占海盗船    (#k目前状态： " + zdhd + ")#l\r\n";
            //selStr += "#L9#" + ttt6 + " [单人]皇帝的复活    (#k目前状态： " + zdgj + ")#l\r\n";
            selStr += " ";

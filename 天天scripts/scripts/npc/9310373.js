...
var month = time.getMonth();//cal.get(java.util.Calendar.MONTH) + 1; //获得月份
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (myRPSql.next()) {
                myRmbPoints = myRPSql.getString("rmb");
            } else {
                myRmbPoints = 0;
            }
            myRPSql.close();
            ...
            //text+="\r\n#k#d您当前的充值积分为：#r"+myRmbPoints+"#k点\r\n#b(积分获得时间：2014/12/18-2015/1/3)#k\r\n\r\n#b";
            text+="#L4#月充值排行说明#l";
            text+="\r\n#L1#查看本月充值排行#l";
            ...
            if (selection==1) {
                ...
                text+="#g======================================================\r\n";
                text+="#b#r1-3#b名返还该月充值总金额的15%点券，以及上述相应奖励。\r\n#r4-6#b名返还该月充值总金额的10%点券，以及10个魔方。\r\n#r7-10#b名返还该月充值总金额的5%点券，以及5个魔方。";
                cm.sendOk(text);
                cm.dispose();
            }
        }

...
var myRmbPoints;
//积分档次
var pointTypes = Array(10,50,100,200,300,500,1000);
//礼包内容
var pointGifts = Array(
	//10积分礼包
	Array(1, 1112918, 1, 3),  //回归戒指
	//50积分礼包
	Array(2, 1112918, 1, 7),  //回归戒指
	Array(2, 4032521, 1),  //VIP入场
	//100积分礼包
	...
	Array(5, 2049323, 10),
	//500积分礼包
	Array(6, 2431996,1,null, "极真装备随机箱子"),
	Array(6, 2049323, 20),
	//1000积分礼包
	Array(7, 1113075, 1), //最高级贝勒德戒指
	Array(7, 1032223, 1), //最高级贝勒德耳环
	Array(7, 1122267, 1), //最高级贝勒德吊坠
	Array(7, 1132246, 1),  //最高级贝勒德腰带
	Array(7, 2049323, 100)
);
var lastGifts = Array();

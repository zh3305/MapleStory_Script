...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "\r\n#e#d您好增金币副本（内有大量金币,搬砖好去处）.#n#l#k\r\n\r\n";
        //selStr +="\r\n#d======================================================#k\r\n";
        selStr += "#b#L0#" + ttt6 + " #r1.#b 超越王思聪的进阶之路 #l\r\n";
        ...
        // selStr += "#L8#" + ttt6 + " #r2. [HOT]#b 无限火力挑战#l\r\n";
        selStr += "#L9#" + ttt6 + " #r2.#b angelababy的新婚洞房 #l\r\n";
        //selStr += "#L10#" + ttt6 + " #r11.#e#b 阿里安特竞技场(New~)#l#n\r\n";
        // selStr += "#L11#" + ttt6 + " #r3. 神话副本<最强神化耳环>#l\r\n";
        // selStr += "#L11#" + ttt6 + " #r12.#e#b 超级斯乌全关挑战！！！！！(New~)#l#n\r\n";
        selStr += "#L20#" + ttt6 + " #r3.#b 你有叶良辰跳的高吗?#l\r\n";

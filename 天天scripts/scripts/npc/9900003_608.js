...
var reward = new Array( // 礼包编号、道具id、数量
    ...
    // Array(3, 5072000, 20), //高质地喇叭
    //Array(3, 4001713, 10),

    // 礼包4 120分钟
    Array(4, 5062000, 20), //神奇魔方
    Array(4, 5072000, 20), //高质地喇叭
    //Array(4, 5062500, 8),
    ...
    // Array(5, 5062002, 10),//高质地喇叭
    Array(5, 5062500, 10), //大师附加神奇魔方
    //Array(5, 2340000, 1),
    //Array(5, 2049124, 3),  //正向混沌卷轴
    Array(5, 2049306, 1), //高级装备强化卷
    //Array(5, 4310110, 1),  //春节纪念币

    // 礼包6 360分钟
    Array(6, 4001550, 1), //100金币
    Array(6, 5062000, 20), //神奇魔方
    //Array(6, 5062002, 12),
    Array(6, 5062500, 10), //大师附加神奇魔方
    //Array(6, 5062010, 1),  // 终极神奇魔方
    // Array(6, 02049700, 5), //高级潜能附加卷
    Array(6, 2049704, 2), // A 级潜能卷
    //Array(6, 2340000, 2),
    Array(6, 5064000, 1), //防爆卷轴
    Array(6, 2049306, 1), //高级装备强化卷
    //Array(6, 2049124, 3), //正向混沌卷轴
    //Array(6, 4310110, 2), //春节纪念币
    Array(6, 2340000, 2), //祝福卷
    Array(6, 2049132, 1), //惊人混沌卷轴
    Array(6, 1992, 8000), //抵用卷


    //礼包7 480分钟
    Array(7, 5062000, 30), //神奇魔方
    Array(7, 5062002, 20), //高级神奇魔方
    Array(7, 5062500, 10), //大师附加神奇魔方
    ...
    //Array(8, 5062000, 15),
    Array(8, 5062002, 20), //高级神奇魔方
    Array(8, 5062500, 15), //大师附加神奇魔方
    Array(8, 2048309, 1), //附加潜能附加卷
    Array(8, 5064000, 2), //防爆卷轴
    Array(8, 4001839, 100), //星星
    Array(8, 2049306, 5), //高级装备强化卷

    //礼包9 720分钟
    //Array(8, 4001714, 15),
    //Array(8, 2450022, 2),
    //Array(8, 2022709, 2),
    Array(9, 4001785, 1), //500W金币
    // Array(9, 2049704, 5), //潜能附加卷40% A级5张
    //Array(8, 4310110, 5),  //春节纪念币
    //Array(8, 5062010, 5),  // 终极神奇魔方
    //Array(8, 5062000, 15),
    Array(9, 5062002, 30), //高级神奇魔方
    Array(9, 5062500, 30), //大师附加神奇魔方
    Array(9, 2048309, 1), //附加潜能附加卷
    // Array(9, 5211060, 1), //三倍经验
    Array(9, 2049116, 1), //强化混沌卷轴
    Array(9, 4001839, 200), //星星
    Array(9, 2049306, 5), //高级装备强化卷
    Array(9, 2340000, 5), //祝福卷
    Array(9, 5064000, 5), //防爆卷轴
    Array(9, 1992, 22000), //抵用卷
    Array(9, 5360015, 1), //双倍爆率增益
    Array(9, 4310030, 1), //运动币


    //1200分钟
    Array(10, 4001551, 1) //1000W金币
);
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        for (var i = 0; i < rewardlist.length; i++) {
            ...
            } else if (rewardlist[i][0] == 1992) { //抵用劵

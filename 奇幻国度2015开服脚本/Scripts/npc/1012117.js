...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple(head + "你好。我是大头国的#b#p1012117##k。如果你有#b#t05150040##k，我可以为你设计一个发型。怎么样？\r\n#b#L0#更换发型(使用皇家理发券)#l");
    } else if (status == 1) {
        if (selection == 0) {
        ...
        if (cm.setRandomAvatar(5150040, hair_Colo_new) == 1) {
            ...
            cm.sendOk(head + "必须要有皇家理发券，我才能为你理发。");
        }
        cm.safeDispose();
    }
}
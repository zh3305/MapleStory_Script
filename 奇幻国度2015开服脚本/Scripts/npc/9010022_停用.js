    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            if (cm.getPlayerStat("LVL") < 10) {
                ...
                var selStr = "";
                if (cm.getPlayerStat("LVL") >= 10) {
                    selStr += "#801#海外旅游#800#中式结婚#27#阿斯旺解放战";
                }
                if (cm.getPlayerStat("LVL") >= 20) {
                    selStr += "#9#月秒的年糕#10#组队训练场#11#时空裂缝";
                }
                ...
                if (cm.getPlayerStat("LVL") >= 70) {
                    selStr += "#12#毒雾森林#13#女神的痕迹#14#老海盗#15#罗密欧和朱丽叶";
                }
            ...
            case 3:
                ...
                break;
            case 4:
                cm.warp(923020000, 0); //雾海 - 触礁的幽灵船
                break;
            case 5:
                cm.warp(926010000, 4); //隐藏地图 - 金字塔山丘
                break;
            case 6:
                cm.warp(910320000, 2); //隐藏地图 - 废弃的地铁站
                break;
            case 7:
                cm.warp(209000000, 0); //隐藏地图 - 幸福村
                break;
            case 8:
                cm.warp(950100000, 9); //隐藏地图 - 黄金寺院
                break;
            case 9:

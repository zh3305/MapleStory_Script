...
var List = Array(
		Array(icon + " #r赞助 <-> 奇幻国度 <-> 链接你我#k\r\n", 703, 0),
        //Array(icon + " #r返回市场#k", 99, 1),
		Array(icon + " #r羊年礼包#k", 2015, 1),
        Array(icon + " 万能传送", 2, 1),
        Array(icon + " 游戏商店", 1, 1),
        Array(icon + " 职业转职", 4, 1),
...
function ListFor(type) {
    switch (type) {
	    ...
	    text += "  " + icon2 + "奇幻国度:有你更精彩 ^_^ \r\n";
            //text += "  " + icon2 + "当前时间:" + year + "-" + month + "-" + day + " " + hour + ":" + minute + ":" + second + "\r\n";
	    text += "  " + icon2 + "当前活跃度:" + cm.getActivity() + "\t当前在线时长:" + cm.getPlayer().getTodayOnlineTime() + "分钟\r\n";
        text += "  " + icon2 + "当前点卷:" + cm.getNX(1) + "点\t当前抵用卷:" + cm.getNX(2) + "点\r\n";
		text += "#L999##b" + icon + " 当前幻币:" + cm.getHyPay(1) + "币  ->  立即兑换 &_&#l\r\n";
            //text += "#e├─────── 奇幻国度服务 ───────┤#n\r\n"
            break;
        case 2://游戏乐园
            //text += "#e├─────── 奇幻国度活动 ───────┤#n\r\n"

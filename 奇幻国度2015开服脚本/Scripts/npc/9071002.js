...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            cm.sendSimple("嗯～本来不能这样的，因为我最近心情很好，所以才会破例卖给你。#r不管是哪种入场券，每人一天只能购买20张#k。对了，这件事一定要对休彼德蔓保密！\r\n#b#L0##t4001514#20万金币#l\r\n#L1##t4001516#40万金币#l\r\n#L2##t4001522#60万金币#l#k");
        }
    } else if (status == 2) {
        if (selection == 0) {
            if (cm.getBossLog("公园入场券") >= 20) {
                cm.sendOk("你今天已经购买了#r20#k张。不能再买了～不然会被休彼德蔓发现的。你明天再来吧～");
            } else if (cm.getMeso() >= 200000 && cm.canHold(4001514)) {
                cm.gainItem(4001514, 1);
                cm.gainMeso( - 200000);
                cm.setBossLog("公园入场券");
                cm.sendOk("祝你在怪物公园里度过愉快的一天！");
            } else {

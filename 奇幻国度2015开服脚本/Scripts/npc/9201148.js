...
function action(mode, type, selection) {
    ...
    if (status == 0) {//如果你有#b#t05152053##k 使用皇家整容院优惠券
        cm.sendSimple(head + "你好，我是整形手术领域的艺术家#b#p9201148##k。如果你有#b#t05152053##k，我可以为你做脸部整形手术。怎么样？ 你想让自己的脸变得完美无瑕吗？\r\n#b#L0# 换脸(使用皇家整容院优惠券)#l");
    } else if (status == 1) {
        cm.sendYesNo(head + "使用皇家整容院优惠券，可以随意更改脸型。但是请别担心，我的手术已经达到了艺术的境界。你真的要使用#b#t05152053##k，变换脸型吗？");
    } else if (status == 2) {
        ...
        if (cm.setRandomAvatar(5152053, facetype) == 1) {
            ...
            cm.sendOk(head + "必须有皇家整容院优惠券，才能进行手术。");
        }
        cm.safeDispose();
    }
}
  ...
  function action(mode, type, selection) {
	  ...
	  if (selection == 0) {
		  ...
		  if(em.getProperty("state1").equals("1")==true){
			  ...
			  cm.setBossLog("szsl");
			  cm.sendOk("" + vvv + "\r\n\r\n此次极限突破你获得了 #r 10 #k个 #r#t2431716##k\r\n#t5062002# x 10个");
			  cm.channelMessage(0x18, "『极限突破』" + " : " + "恭喜" + cm.getChar().getName() + ",和他的队友完成了极限突破，试炼评分 < S > 级");
			  ...
			  cm.setEventCount("szsl");
			  cm.setBossLog("szsl");
			  cm.sendOk("" + vvv + "\r\n\r\n此次极限突破你获得了 #r 5 #k个 #r#t2431716##k\r\n#t5062002# x 5个");
			  cm.channelMessage(0x18, "『极限突破』" + " : " + "恭喜" + cm.getChar().getName() + ",和他的队友完成了极限突破，试炼评分 < F > 级");
			  ...
			  cm.sendOk("" + vvv + "\r\n\r\n此次极限突破你获得了 #r 3 #k个 #r#t2431716##k\r\n#t5062002# x 3个");
			  cm.channelMessage(0x18, "『极限突破』" + " : " + "恭喜" + cm.getChar().getName() + ",和他的队友完成了极限突破，试炼评分  < A > 级");
			  ...
			  cm.setEventCount("szsl");
			  cm.setBossLog("szsl");
			  cm.sendOk("" + vvv + "\r\n\r\n此次极限突破你获得了 #r 1 #k个 #r#t2431716##k\r\n#t5062002# x 1个");
			  cm.channelMessage(0x18, "『极限突破』" + " : " + "恭喜" + cm.getChar().getName() + ",和他的队友完成了极限突破，试炼评分 < B > 级");

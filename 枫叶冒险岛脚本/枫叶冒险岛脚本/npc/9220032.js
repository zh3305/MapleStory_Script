...
var item = Array(
        ...
        Array(1102383, 8800),
        Array(1142524, 12000),
		Array(1072732, 10000), // 赫里希安精锐战士靴 // (无描述)
		Array(1072733, 10000), // 赫里希安精锐法师靴 // (无描述)
		Array(1072734, 10000), // 赫里希安精锐弓箭手靴 // (无描述)
		Array(1072735, 10000), // 赫里希安精锐飞侠靴 // (无描述)
		Array(1072736, 10000), // 赫里希安精锐海盗靴 // (无描述)
        Array(1102476, 14000),
        Array(1102477, 14000),
        Array(1102478, 14000),
        Array(1102479, 14000),
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            if (cm.getParty() == null) { // 没有组队
                ...
                cm.sendOk("请叫队长和我谈话。");
                cm.dispose();
            } else if (cm.getBossLog('天空庭院') >= 3) {
                cm.sendOk("你不能进去，天空庭院一天只能进入3次。")
                cm.dispose();
            } else {

...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        var selStr = "- #d#e绑定枫叶冒险岛币商城系统#n#k：\r\n\r\n";
	selStr += "#d您当前拥有可用点卷为： #r " + cm.getPlayer().getCSPoints(1) + " #k#d点\r\n您当前拥有绑定枫叶冒险岛币：  #r"+cm.getPlayerPoints()+"#k #d点#k\r\n\r\n";
	selStr += "#b#L0#"+ttt6+" 购买绑定枫叶冒险岛币[点卷购买比率 1：20]#l\r\n\r\n";
	selStr += "#L1#"+ttt6+" 绑定枫叶冒险岛币商城[内置抵用卷商店]#l\r\n\r\n";
	selStr += "#L2#"+ttt6+" 打开网站进行充值[本服充值专用]#l\r\n\r\n";
        ...
        case 2:
            cm.dispose();
            cm.openWeb("http://www.minimxd.com");
            break;

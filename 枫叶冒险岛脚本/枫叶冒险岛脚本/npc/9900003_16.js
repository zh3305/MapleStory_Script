...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		selStr += "#L6#"+ aaa +" 3000抵用卷换取#t2049704##l\r\n";
		selStr += "#L7#"+ aaa +" 1000W金币换取500抵用卷#l\r\n";
		//selStr += "#L3#"+ aaa +" 100000绑定枫叶冒险岛币抽取极真系列#l\r\n";
 cm.sendSimple(selStr);
		...
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1000抵用卷兑换神奇魔方1个。");
		cm.dispose();
            } else {
		...
		cm.gainItem(jizhen[chance],1);
                cm.sendOk("兑换成功。绑定枫叶冒险岛币减少1500,获取#z"+jizhen[chance]+"一个.");
		cm.worldSpouseMessage(0x20, "『绑定枫叶冒险岛币兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1500绑定枫叶冒险岛币抽取" + ii.getName(jizhen[chance]) + "一个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的绑定枫叶冒险岛币(请在市场挂机获得)!\r\n2). 您的点卷不足30万。请通过免费渠道获得。");
				cm.dispose();
            }
            break;
        case 4:
            if (cm.getPlayer().getCSPoints(2) >= 5000 && cm.getBossLog("抵用卷魔方") <= 9){
                cm.gainNX(2, -5000);
		...
		cm.gainItem(2049704,1, 1);
                cm.sendOk("兑换成功。抵用卷减少3000.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用3000抵用卷兑换A潜能卷1个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();

...
var reward = new Array(// 礼包编号、道具id、数量
					...
					Array(7, 5062002, 2),
					Array(7, 5062500, 2),
					Array(7, 5062010, 1),  // 终极神奇魔方
					Array(7, 2340000, 3),
					Array(7, 5064000, 3),  //防爆卷轴
					Array(7, 2049306, 2), //高级装备强化卷
					Array(7, 2049135, 1), //惊人正义20%

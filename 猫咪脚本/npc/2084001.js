...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("瞧一瞧看一看，老夫从海外带回来的珍宝，一个只要#r"+cost+"点卷#k，能够获得#b强化卷、蓝调、必成卷、风暴套装、150级稀有防具、稀有椅子等高级物品#v3010519##v3010520##v3012011##v3010621##k，打开宝箱就送你#r5个#k#b运动会币#k，运动会币能兑换#b必成卷轴#k和#b运动会装备#k哦！！！买个玩玩吧，小兄弟！ \r\n#L0##b买1个宝箱玩玩吧#k#l\r\n#L1##b买10个宝箱玩玩吧#k#l\r\n#L2##r老板，我要100个！#k#l");
    } else if (status == 1) {
		if (selection == 0) {

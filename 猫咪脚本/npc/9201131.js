...
function start() {
    cm.sendNext("#r想得到更高攻击的装备吗？挑战最高攻击极限,你只要给我两个相同的物品(不可以潜能或砸卷)，就可以合成更高级的武器，举例说明一下：\r\n--------------------------------------------------#k\r\n如果你有#b两把普通的160双手剑#k，那么交给我后，我将给你一把名字为：[#r ① #k]的160级双手剑，攻击肯定要#b比普通的高#k哟\r\n--------------------------------------------------\r\n如果你有两把名字为：[ #r①#k ]的160级双手剑，可以继续找我合成名字为：[ #r②#k ]的160级双手剑.\r\n--------------------------------------------------\r\n#k你大概明白合成的方法了吧？\r\n 不明白也没关系，点击下一步我们正式的合成一把看，合成上面没有的装备可以联系客服QQ提供装备名字添加~#r注意，这个只能合成天然的装备，加过属性的装备合成的话属性会丢失，所以请注意!!!");
}

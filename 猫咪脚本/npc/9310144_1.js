...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if(typed==1){
                if (cm.haveItem(4310110, 220)) {
			cm.gainItem(4310110, -220);

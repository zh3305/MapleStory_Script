...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) { 
			cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好!想选择什么样的特别活动:\r\n#r#L1##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#活动专栏简介#l\r\n\r\n #k  #fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#今天在线：#r"+cm.getGamePoints()+"#k 分钟#b\r\n\r\n#fUI/UIWindow2.img/QuestGuide/Button/WorldMapQuestToggle/normal/0#\r\n#L3##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[运气]豪情赌拿中介    (#k目前状态： #r火爆推荐#b)#l\r\n#L6##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[春节]免费一键潜能    (#k目前状态： #r火爆推荐#b)#l\r\n#L9##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[兑换]兑换神奇魔方    (#k目前状态： #r火爆推荐#b)#l\r\n#L4##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[武器]伤害上限突破    (#k目前状态： #r火爆推荐#b)#l\r\n  ");
		} else if (status == 1) {
			if (selection == 1) {
			...
			typed=3;
			cm.sendSimple("#fUI/UIWindow2.img/Quest/quest_info/summary_icon/summary#\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#亲爱的#r#h ##k您好,欢迎来到年终充值礼包活动:\r\n  达到一定赞助额度你可以获得大礼包一份\r\n#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#账号目前 (#k当前拥有点卷: #r" + cm.getNX(1) + "#k)#b\r\n#fUI/UIWindow2.img/Quest/quest_info/summary_icon/startcondition#\r\n#L2##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r30W#b  点卷礼包#l\r\n#L3##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r150W#b  点卷礼包#l\r\n#L4##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r300W#b 点卷礼包#l\r\n#L5##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r900W#b 点卷礼包#l\r\n#L6##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r1800W#b 点卷礼包#l\r\n#L7##fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#[新年赞助礼包]查看#r3000W#b点卷礼包#l\r\n\r\n   #r#fUI/UIWindow2.img/QuestAlarm/BtQ/normal/0#");

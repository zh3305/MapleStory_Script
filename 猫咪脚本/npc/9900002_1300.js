...
var status = -1;
var potList = Array(
Array(40603, "攻击BOSS时伤害：+40%", 1500),
Array(40292, "无视怪物40%的防御率", 1500),
Array(42051, "攻击力：+12%", 1500),
Array(60001, "总伤害：+12% ", 1500),
Array(60002, "所有属性：+20% ", 1500),
Array(60007, "MaxHP : +10% ", 1500),
Array(60008, "攻击力/魔力：+10% ", 1500),
Array(40055, "爆击率 12%", 1500));
var potId = -1; //潜能的ID
var depict = ""; //潜能的描述
var points = -1; //每次的价格

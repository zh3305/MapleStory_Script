...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		selStr += "#r#L0#"+ aaa +" 600抵用卷换取#t5062000#x1( "+cm.getBossLog("抵用卷神奇")+" / 30次)#l\r\n";
		selStr += "#L2#"+ aaa +" 5000抵用卷随即抽取120-140装备#l\r\n";
		selStr += "#L4#"+ aaa +" 1500抵用卷换取#t5062002#x1( "+cm.getBossLog("抵用卷魔方")+" / 10次)#l\r\n";
 ...
 cm.sendSimple(selStr);
		...
		cm.setBossLog("抵用卷神奇");
                cm.sendOk("兑换成功。抵用卷减少600.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用600抵用卷兑换神气魔方1个。");
		cm.dispose();
            } else {
		...
		cm.gainItem(item[chance],1);
                cm.sendOk("兑换成功。抵用卷减少5000,获取#z"+item[chance]+"一个.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用5000抵用卷抽取" + ii.getName(item[chance]) + "一个。");
		cm.dispose();
            } else {
                cm.sendOk("#r兑换失败:\r\n\r\n#b1). 你没有足够的抵用卷(请在市场挂机,或打怪获得)!");
				cm.dispose();
		...
		cm.dispose();
            ...
            break;
        case 4:
            if (cm.getPlayer().getCSPoints(2) >= 1500 && cm.getBossLog("抵用卷魔方") <= 9){
                cm.gainNX(2, -1500);
		cm.gainItem(5062002,1);
		cm.setBossLog("抵用卷魔方");
                cm.sendOk("兑换成功。抵用卷减少1500.");
		cm.worldSpouseMessage(0x20, "『抵用卷兑换』" + " : " + "恭喜" + cm.getChar().getName() + ",在市场<普通服务员>处用1500抵用卷兑换高级神气魔方1个。");
		cm.dispose();
            } else {

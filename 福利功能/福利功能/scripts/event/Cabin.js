...
function scheduleNew() {
	...
	em.getChannelServer().getMapFactory().getMap(240000110).broadcastMessage(MaplePacketCreator.serverNotice(0, "神木村开往天空之城的船已经到达.请抓紧时间上船"));
	em.getChannelServer().getMapFactory().getMap(240000110).broadcastMessage(MaplePacketCreator.playSound("Whistle"));
	em.getChannelServer().getMapFactory().getMap(200000131).broadcastMessage(MaplePacketCreator.serverNotice(0, "天空之城开往神木村的船已经到达.请抓紧时间上船"));
...
function takeoff() {
	...
	em.getChannelServer().getMapFactory().getMap(240000110).broadcastMessage(MaplePacketCreator.serverNotice(0, "神木村开往天空之城的船已经出发."));
	em.getChannelServer().getMapFactory().getMap(240000110).broadcastMessage(MaplePacketCreator.playSound("Whistle"));
	em.getChannelServer().getMapFactory().getMap(200000131).broadcastMessage(MaplePacketCreator.serverNotice(0, "天空之城开往神木村的船已经出发."));
	em.getChannelServer().getMapFactory().getMap(200000131).broadcastMessage(MaplePacketCreator.playSound("Whistle"));

...
function setup() { 
 ...
 var instanceName = "vip5" + instanceId;//任务名 
...
function playerEntry(eim, player) { 
 ...
 player.getClient().getSession().write(net.sf.odinms.tools.MaplePacketCreator.getClock(60));//600为时间限制10分钟。 
 player.getClient().getSession().write(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, "[注意]你已进入任务地图.")); 

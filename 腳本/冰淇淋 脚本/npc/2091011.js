...
var rewardItem = new Array(
						new Array(1082392, 350),	// Lv120 - 英雄手套 - 送给武陵道场最强挑战者的传说中的手套。
...
var secretBox = 5062002; // 秘密箱子 - Lv140套装
var rewardsel;
...
function action(mode, type, selection) {
	if (mode <= 0) {
		...
		if (status == 0) {
			...
			text = "\t\t\t\t#r#e- 新版武陵道场 -#n#k\r\n\r\n\t欢迎来到新版武陵道场，这里每一层都有实力强大的怪物与你一决雌雄，当然奖励也很丰富，运气好的话可以从怪物身上获得#b#z" + taskItem + "##k，可在我这里兑换特有的装备奖励，随着难度的提升，经验也会越来越丰富，目前已开放#r30层#k，且在#r17层、29层#k消灭怪物后会获得#b<#z" + secretBox + "#-高级神奇魔方>#k丰富大奖，要注意捡取哦！期待您的精彩表现~\r\n\r\n";
			...
			if (selection == 0) {
				...
				text += "- 通关奖励\r\n  每层都会有机率掉落#b#z" + taskItem + "##k，在#r17层、29层#k消灭该层所有怪物后会掉落#b<#z" + secretBox + "#-Lv140套装>#k，打开后可获得数量不等的极品套装。\r\n\r\n";

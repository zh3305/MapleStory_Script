...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			selStr +="#L1##b"+aaa+" 超级实惠理财服务30000点/周[详情点击查看]#l#k\r\n\r\n";
			selStr +="#L2##b"+aaa+" 超级实惠理财服务100000/月[详情点击查看]#l#k\r\n\r\n";
			//selStr +="#L3##b"+aaa+" 随身服务包一年权[详情点击查看]#l#k\r\n";
                        cm.sendSimple(selStr);	
		} else if (status == 1) {
			if (selection == 1) {
				typed=1;
				cm.sendYesNo("- #e#d欢迎办理随身服务7天权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 30元现金/7天#k\r\n\r\n- #e#d随身服务特权：#n#k\r\n\t\t#b每日可以拿3000万金币工资。\r\n\t\t可自主选择发型。可使用快捷洗血功能。\r\n\t\t每日大量魔方，积分，活力，抽奖\r\n\t\t快捷传送，三倍经验，双倍爆率\r\n\t\t购买点卷特权获得双倍，以及专署副本。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
			} else if (selection == 2) {
				typed=2;
				...
				typed=3;
				cm.sendYesNo("- #e#d欢迎办理随身服务一年权：#n#k\r\n\r\n- #e#r提示:#k#n  #rvip神秘盒子 1200元现金/年#k\r\n\r\n- #e#d随身服务特权：#n#k\r\n\t\t#b每日可以拿3000万金币工资。\r\n\t\t可自主选择发型。可使用快捷洗血功能。\r\n\t\t每日大量魔方，积分，活力，抽奖\r\n\t\t快捷传送，三倍经验，双倍爆率\r\n\t\t购买点卷特权获得双倍，以及专署副本。\r\n\r\n- #e#d管理提示：#n#b点是进行购买。点否返回上一页.#k");
                        } else if (selection == 4) {
				typed=4;
				cm.sendYesNo("");	
			}
			...
			if(typed==1){
                if (cm.haveItem(2430865) < 1 && cm.getSpace(2) > 2 && cm.getPlayer().getCSPoints(1) >= 30000) {
			cm.gainItem(2430865,1,7);
			cm.gainNX(1, -30000);
			cm.sendOk("恭喜您成功购买7天随身服务.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功购买理财服务7天权。", 5120012);
			cm.worldSpouseMessage(0x20, "[系统公告] : 恭喜 " + cm.getChar().getName() + " 成功购买7天理财服务.");
			cm.dispose();
                } else {
			cm.sendOk("失败：\r\n\r\n#r1). 您的随身服务未到期,无法重复办理.\r\n2). 充值金额未达到条件.\r\n3). 背包里消耗栏位已满,请清理.");
			cm.dispose();
